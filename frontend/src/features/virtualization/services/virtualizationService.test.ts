/**
 * virtualizationService tests — Phase 105
 */
...
describe('virtualizationService', () => {
  ...
  it('create calls POST on correct URL', async () => {
    ...
    await virtualizationService.createDataset({ name: 'test' } as never);
  ...
  it('handles network error gracefully', async () => {
    ...
    await expect(virtualizationService.listDatasets()).rejects.toThrow('Network Error');
  });
