/**
 * datasetService tests — Phase 105
 */
...
describe('datasetService', () => {
  ...
  it('create calls POST on correct URL', async () => {
    ...
    await datasetService.create({ name: 'test' } as never);
  ...
  it('delete calls DELETE on correct URL', async () => {
    ...
    await datasetService.delete('test-id');
  ...
  it('handles network error gracefully', async () => {
    ...
    await expect(datasetService.list()).rejects.toThrow('Network Error');
  });
