/**
 * ComplianceRunListPage smoke test — Phase 106
 */
...
import { ComplianceRunListPage } from './ComplianceRunListPage';

describe('ComplianceRunListPage', () => {
  ...
  it('renders without crashing', async () => {
    render(<ComplianceRunListPage />, { wrapper: Wrapper });
    // Component should mount without throwing
    expect(document.body.innerHTML.length).toBeGreaterThan(0);
  });

  it('mounts and processes initial render cycle', async () => {
    const { container } = render(<ComplianceRunListPage />, { wrapper: Wrapper });
