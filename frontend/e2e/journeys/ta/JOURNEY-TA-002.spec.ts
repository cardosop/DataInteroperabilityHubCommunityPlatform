/**
 * E2E Test: JOURNEY-TA-002 — Configure Tenant Settings
 *
 * Journey: Configure Tenant Settings
...
test.describe('JOURNEY-TA-002: Configure Tenant Settings', () => {
  test.setTimeout(240000); // 4 min: visible/slowMo + login can exceed 2 min

  test.describe('Success', () => {
    test('admin page loads for tenant settings', async ({ page }) => {
