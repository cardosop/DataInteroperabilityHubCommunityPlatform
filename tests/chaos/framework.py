...
class ChaosEngine:
    ...
    def inject_failure(self, scenario: ChaosScenario, func: Callable, *args, **kwargs) -> Any:
        """
    ...
    def _inject_network_timeout(
        self, scenario: ChaosScenario, func: Callable, *args, **kwargs
    ) -> Any:
        """Inject network timeout failure"""
        timeout = scenario.metadata.get("timeout", 0.1) if scenario.metadata else 0.1
        raise TimeoutError(f"Network timeout after {timeout}s (chaos injection)")
    ...
    def run_chaos_test(
        self, scenario: ChaosScenario, test_func: Callable, *args, **kwargs
    ) -> tuple[bool, str | None]:
        """
        ...
        try:
            ...
            self.inject_failure(scenario, test_func, *args, **kwargs)
