...
class TestCriticalAlertsExist:
    ...
    def test_service_down_alert_exists(self):
        ...
        assert "ServiceDown" in content, \
            "ServiceDown alert must be defined in Prometheus config"
        assert 'severity: critical' in content.lower() or \
            'severity:' in content, \
    ...
    def test_high_error_rate_alert_exists(self):
        ...
        assert "HighErrorRate" in content, \
            "HighErrorRate alert must be defined"

    def test_high_job_queue_depth_alert_exists(self):
        """HighJobQueueDepth alert is defined."""
        content = self._read_all_alerts()
        assert "HighJobQueueDepth" in content or "JobQueue" in content or \
    ...
    def test_alerts_have_severity_labels(self):
        ...
        assert severity_count > 0, \
            "Alerts must have severity labels for routing"
    ...
    def test_alerts_have_summary_and_description(self):
        ...
        assert summary_count > 0, \
            "Alerts must have summary annotations for oncall runbooks"
...
class TestPrometheusConfigSyntax:
    ...
    def test_alerts_yml_is_valid_yaml(self):
        ...
        try:
            ...
            pytest.skip("yaml library not installed")
    ...
    def test_alert_files_use_valid_promtool(self):
        ...
        try:
            ...
            pytest.skip("promtool not installed — skipping syntax validation")
        except Exception:
