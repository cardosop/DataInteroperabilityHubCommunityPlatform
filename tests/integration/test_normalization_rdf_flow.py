...
class NormalizationRDFFlowTest(TestCase):
    ...
    def test_datacontract_com_normalize_then_map_to_rdf(self):
        """Test DataContract.com contract: normalize → map to RDF"""
        dc_contract_json = """{
            "id": "test-contract",
            ...
            "quality": {
                "defaultProfileKey": "intake_basic",
                "rules": [
                    {
                        "rule_id": "not_null_id",
                        "dimension": "completeness",
            ...
            "privacy": {
                ...
                "personalDataCategories": ["PII_DIRECT_EMAIL"],
                "jurisdictions": ["GDPR"],
                "legalBases": ["CONSENT"]
            },
            "lifecycle": {
                "dataSource": "source.example.com",
                "refreshCadence": "DAILY",
                "slas": {"availability": "99.0"}
            },
            "marketplace": {
                "licenseSummary": "MIT License",
                "intendedUse": ["analytics"],
                "restrictedUse": []
            }
        }"""
