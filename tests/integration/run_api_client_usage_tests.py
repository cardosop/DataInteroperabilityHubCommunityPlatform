#!/usr/bin/env python3
"""
Standalone test runner for API Client Usage Search tests.
...
TestAPIClientUsageSearch = test_module.TestAPIClientUsageSearch
...
def run_tests():
    ...
    print("=" * 80)
    print("Running API Client Usage Search Tests")
    print("=" * 80)
    print()
