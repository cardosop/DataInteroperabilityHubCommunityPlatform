...
class DatabaseQueriesTest(TestCase):
    ...
    def test_complex_query(self):
        ...
        assets = Asset.objects.filter(
            Q(tenant=self.tenant) & Q(status='DRAFT')
        )
    ...
    def test_annotate_query(self):
        """Test annotate query"""
        # Annotate query
        tenants_with_user_count = Tenant.objects.annotate(
...
class JSONFieldOperationsTest(TestCase):
    ...
    def test_jsonfield_update(self):
        ...
        asset = Asset.objects.create(
            tenant=self.tenant,
            key="json-update-asset",
            name="JSON Update Asset",
            status='DRAFT'
        )
    ...
    def test_jsonfield_nested_query(self):
        ...
        asset = Asset.objects.create(
            tenant=self.tenant,
            key="json-nested-asset",
            name="JSON Nested Asset",
            status='DRAFT'
        )
    ...
    def test_unique_constraints(self):
        ...
        with self.assertRaises(Exception):  # IntegrityError or ValidationError
            Tenant.objects.create(
                ...
                slug="unique-test-tenant"  # Same slug
            )
