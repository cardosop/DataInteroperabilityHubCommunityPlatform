...
class TestPrometheusMetricsConfiguration:
    ...
    def test_metrics_endpoint_labels_dynamic(self):
        ...
        assert (
            "request.path" in content or "resolver_match" in content or "route" in content.lower()
...
class TestGrafanaDashboards:
    ...
    def test_key_dashboards_exist(self):
        """Test that required dashboards exist (single source: monitoring_constants)."""
        for dashboard_name in REQUIRED_GRAFANA_DASHBOARDS:
