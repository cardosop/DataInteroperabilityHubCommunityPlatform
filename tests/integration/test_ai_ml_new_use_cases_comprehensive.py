...
class AIMLNewUseCasesTestBase(TestCase, TestDatabaseIsolationMixin):
    ...
    def setUp(self):
        ...
        UserRole.objects.get_or_create(
            user=self.dc_user, role=self.data_consumer_role,
        )
        ...
        UserRole.objects.get_or_create(
            user=self.ds_user, role=self.data_scientist_role,
        )
...
class UCAI003MLAnomalyDetectionTest(AIMLNewUseCasesTestBase):
    ...
    def test_anomaly_detection_via_dq_results(self):
        ...
        self.assertEqual(
            dq_resp.status_code, status.HTTP_201_CREATED,
        )
        ...
        self.assertEqual(
            results_resp.status_code, status.HTTP_200_OK,
        )
