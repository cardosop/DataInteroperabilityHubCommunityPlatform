...
class TestEventBusMetricsExposure:
    ...
    def test_metrics_endpoint_accessible(self, client):
        ...
        try:
            ...
            assert 'text/plain' in response['Content-Type'] or 'text/plain; version=0.0.4' in response['Content-Type']
        except Exception:
            pytest.skip("Metrics endpoint not available (OpenTelemetry may not be configured)")
    ...
    def test_event_publish_metrics_exposed(self, client):
        ...
        try:
            ...
            assert 'event_publish_duration_seconds' in content or '# HELP event_publish_duration_seconds' in content
            assert 'event_publish_failed_total' in content or '# HELP event_publish_failed_total' in content
        except Exception:
    ...
    def test_event_consume_metrics_exposed(self, client):
        ...
        try:
            ...
            assert 'event_processing_duration_seconds' in content or '# HELP event_processing_duration_seconds' in content
            assert 'event_consume_failed_total' in content or '# HELP event_consume_failed_total' in content
        except Exception:
            pytest.skip("Metrics endpoint not available")
    ...
    def test_event_retry_metrics_exposed(self, client):
        ...
        try:
            ...
            assert 'event_handler_retry_count' in content or '# HELP event_handler_retry_count' in content
            assert 'event_retry_attempts_total' in content or '# HELP event_retry_attempts_total' in content
        except Exception:
            pytest.skip("Metrics endpoint not available")
