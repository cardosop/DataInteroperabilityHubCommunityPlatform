...
class TestWebhookPayloadsAndEventsSearch:
    ...
    def test_report_exists(self):
        ...
        assert self.report_path.exists(), f"Webhook payloads and events report not found at {self.report_path}"
    ...
    def test_endpoint_references_found(self):
        ...
        report = self.report
        assert report['summary']['total_endpoint_references'] > 0, "No webhook endpoint references found"
    ...
    def test_subscription_configs_found(self):
        ...
        report = self.report
        assert report['summary']['total_subscription_configs'] > 0, "No subscription configurations found"
    ...
    def test_webhook_endpoints_found(self):
        ...
        report = self.report
        webhook_endpoints = [
            ref for ref in report['endpoint_references']
    ...
    def test_odps_event_types_found(self):
        ...
        report = self.report
        odps_event_types = [
            et for et in report['summary']['event_types']
            if et.startswith('odps.')
        ]
    ...
    def test_subscription_event_types_valid(self):
        ...
        for config in report['subscription_configs'][:20]:  # Check first 20
            ...
            for event_type in event_types:
                ...
                if '.' not in event_type or not any(event_type.startswith(prefix) for prefix in valid_prefixes):
    ...
    def test_endpoint_references_diversity(self):
        ...
        found_operations = [
            keyword for keyword in operation_keywords
    ...
    def test_webhook_service_references(self):
        ...
        service_references = [
            ref for ref in report['endpoint_references']
            if 'service' in ref.get('context', '').lower() or 'WebhookDeliveryService' in ref.get('context', '')
        ]
