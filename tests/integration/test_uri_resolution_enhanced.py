...
class URIResolutionEnhancedTest(TestCase):
    ...
    def test_resolve_contract_uri_returns_jsonld(self):
        ...
        if (
            ...
            pytest.skip("Semantic service unavailable (circuit breaker open)")  # noqa: skip-in-body — runtime service dependency
    ...
    def test_resolve_uri_field_resource(self):
        ...
        result = self.client.resolve_uri("field", f"{self.contract.id}/email")
        self.assertIsInstance(result, dict)
