...
class CLIIntegrationTest:
    ...
    def test_cli_login_with_real_api(self, runner, temp_config_dir, test_user_and_tenant, django_api_client):
    ...
    def test_cli_error_handling_invalid_endpoint(self, runner, temp_config_dir, test_user_and_tenant):
