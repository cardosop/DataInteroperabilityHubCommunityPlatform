...
class ConcurrencyLimitsTest(TestCase):
    ...
    def test_check_tenant_job_limits_within_concurrency_limit(self):
        ...
        TenantConfigFactory.create_tenant_config(
            tenant=self.tenant, max_job_concurrency=5, max_queued_jobs=10
        )
    ...
    def test_check_tenant_job_limits_at_concurrency_limit(self):
        ...
        TenantConfigFactory.create_tenant_config(
            tenant=self.tenant, max_job_concurrency=2, max_queued_jobs=10
        )
    ...
    def test_check_tenant_job_limits_within_queued_limit(self):
        ...
        TenantConfigFactory.create_tenant_config(
            tenant=self.tenant, max_job_concurrency=10, max_queued_jobs=5
        )
    ...
    def test_check_tenant_job_limits_at_queued_limit(self):
        ...
        TenantConfigFactory.create_tenant_config(
            tenant=self.tenant, max_job_concurrency=10, max_queued_jobs=3
        )
    ...
    def test_tenant_isolation(self):
        ...
        TenantConfigFactory.create_tenant_config(
            tenant=self.tenant, max_job_concurrency=2, max_queued_jobs=5
        )
        TenantConfigFactory.create_tenant_config(
            tenant=self.tenant2, max_job_concurrency=3, max_queued_jobs=7
        )
