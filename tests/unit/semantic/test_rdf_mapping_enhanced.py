...
class EnhancedRDFMappingTest(TestCase):
    ...
    def test_map_contract_with_semantic_types(self):
        ...
        hub_contract = ContractFactoryEnhanced.create_hub_contract_json(
            schema_fields=[
                {"name": "email", "data_type": "string", "semantic_type": "EMAIL"},
                {"name": "phone", "data_type": "string", "semantic_type": "PHONE"},
                {"name": "order_id", "data_type": "string", "semantic_type": "ORDER_ID"},
            ]
        )
    ...
    def test_map_contract_with_unique_constraints(self):
        ...
        hub_contract = ContractFactoryEnhanced.create_hub_contract_json(
            schema_fields=[{"name": "email", "data_type": "string", "is_unique": True}],
    ...
    def test_map_contract_with_indexes(self):
        ...
        hub_contract = ContractFactoryEnhanced.create_hub_contract_json(
            schema_fields=[{"name": "email", "data_type": "string", "is_indexed": True}],
    ...
    def test_map_contract_with_lifecycle_policy_prov(self):
        ...
        hub_contract = ContractFactoryEnhanced.create_hub_contract_json(
            lifecycle_policy={
                ...
                "refresh_cadence": "DAILY",
                "slas": {"availability": "99.9", "latency_ms_p95": 1000, "latency_ms_p99": 2000},
            }
        )
    ...
    def test_map_contract_with_empty_marketplace_policy(self):
        ...
        hub_contract = ContractFactoryEnhanced.create_hub_contract_json(
            marketplace_policy={"license_summary": None, "intended_use": [], "restricted_use": []}
        )
