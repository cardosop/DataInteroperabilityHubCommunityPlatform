...
class RateLimitKeyGenerationTest(TestCase):
    ...
    def test_tenant_key_generation(self):
        ...
        self.assertEqual(
            key,
            'rate_limit:tenant:test-tenant-id:dq_run:60'
        )
    ...
    def test_user_key_generation(self):
        ...
        self.assertEqual(
            key,
            'rate_limit:tenant:test-tenant-id:user:test-user-id:file_upload:10'
        )
    ...
    def test_api_key_generation(self):
        ...
        self.assertEqual(
            key,
            'rate_limit:tenant:test-tenant-id:apikey:test-api-key-id:catalog_read:86400'
        )
