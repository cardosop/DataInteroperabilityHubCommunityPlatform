...
class TenantConfigModelTest(TestCase):
    ...
    def test_rate_limits_json_field(self):
        ...
        config = TenantConfig.objects.create(tenant=self.tenant, rate_limits=rate_limits)
    ...
    def test_rate_limits_empty_dict(self):
        ...
        config = TenantConfig.objects.create(tenant=self.tenant, rate_limits={})
    ...
    def test_rate_limits_null(self):
        ...
        config = TenantConfig.objects.create(tenant=self.tenant, rate_limits=None)
    ...
    def test_allowed_compliance_regimes_empty_list(self):
        ...
        config = TenantConfig.objects.create(tenant=self.tenant, allowed_compliance_regimes=[])
    ...
    def test_default_compliance_regimes_empty_list(self):
        ...
        config = TenantConfig.objects.create(tenant=self.tenant, default_compliance_regimes=[])
    ...
    def test_data_retention_days_none(self):
        ...
        config = TenantConfig.objects.create(tenant=self.tenant, data_retention_days=None)
    ...
    def test_max_file_size_bytes_none(self):
        ...
        config = TenantConfig.objects.create(tenant=self.tenant, max_file_size_bytes=None)
    ...
    def test_max_job_concurrency_none(self):
        ...
        config = TenantConfig.objects.create(tenant=self.tenant, max_job_concurrency=None)
    ...
    def test_max_queued_jobs_none(self):
        ...
        config = TenantConfig.objects.create(tenant=self.tenant, max_queued_jobs=None)
    ...
    def test_default_dq_profile_none(self):
        ...
        config = TenantConfig.objects.create(tenant=self.tenant, default_dq_profile=None)
    ...
    def test_rate_limits_invalid_category(self):
        ...
        config = TenantConfig.objects.create(
            tenant=self.tenant, rate_limits={"invalid_category": {"burst_per_10s": 10}}
        )
    ...
    def test_rate_limits_negative_values(self):
        ...
        config = TenantConfig.objects.create(
            tenant=self.tenant, rate_limits={"dq_runs": {"burst_per_10s": -10}}
        )
    ...
    def test_rate_limits_zero_values(self):
        ...
        # This will be caught by RateLimitsSerializer (min_value=1)
        config = TenantConfig.objects.create(
            tenant=self.tenant, rate_limits={"dq_runs": {"burst_per_10s": 0}}
        )
        # Model accepts it (JSON field), but serializer will reject it
    ...
    def test_rate_limits_partial_updates(self):
        ...
        config1 = TenantConfig.objects.create(
            tenant=self.tenant, rate_limits={"dq_runs": {"burst_per_10s": 20}}
        )
        ...
        config2 = TenantConfig.objects.create(
            tenant=tenant2, rate_limits={"dq_runs": {"sustained_per_min": 60}}
        )
        ...
        config3 = TenantConfig.objects.create(
            tenant=tenant3, rate_limits={"dq_runs": {"daily_cap": 10000}}
        )
    ...
    def test_str_method(self):
        ...
        tenant2 = Tenant.objects.create(
            name=f"Another Tenant {uuid.uuid4().hex[:8]}",
