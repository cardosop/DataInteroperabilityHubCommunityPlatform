...
class GetTenantConfigTest(TestCase):
    ...
    def test_returns_platform_defaults_when_config_doesnt_exist(self):
        ...
        self.assertEqual(config_dict["default_dq_profile"], self.platform_defaults["default_dq_profile"])
        ...
        self.assertEqual(config_dict["max_job_concurrency"], self.platform_defaults["max_job_concurrency"])
