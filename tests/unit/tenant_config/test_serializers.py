...
class RateLimitsSerializerTest(TestCase):
    ...
    def test_valid_rate_limit_structure_all_categories(self):
        ...
        categories = ["dq_runs", "compliance_runs", "file_uploads", "contract_validation", "catalog_reads", "sparql_queries"]
        ...
        for category in categories:
            ...
            self.assertTrue(serializer.is_valid(), f"RateLimitsSerializer invalid for category {category}: {serializer.errors}")
...
class TenantConfigSerializerTest(TestCase):
    ...
    def test_deserialization_with_valid_data(self):
        ...
        self.assertEqual(serializer.validated_data["allowed_compliance_regimes"], ["GDPR", "LGPD", "CCPA"])
    ...
    def test_deserialization_with_invalid_compliance_regime(self):
        ...
        data = {
            "allowed_compliance_regimes": ["GDPR", "INVALID_REGIME"]
        }
...
class TenantConfigUpdateSerializerTest(TestCase):
    ...
    def test_partial_update_with_none(self):
        ...
        original_profile = self.config.default_dq_profile
