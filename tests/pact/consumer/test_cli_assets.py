...
class TestCLIAssetsContract:
    ...
    def test_list_assets(self):
        ...
        (
            pact.given("assets exist")
            .upon_receiving("list assets with status filter")
            .with_request(
                "GET", "/api/v1/assets/", query={"status": "ACTIVE", "limit": "50", "offset": "0"}
            )
    ...
    def test_asset_not_found(self):
        ...
        (
            pact.given("asset does not exist")
    ...
    def test_create_asset(self):
        ...
        (
            pact.given("tenant can create assets")
