...
class TestScheduledExportContract:
    ...
    def test_list_exports(self, export_pact):
        export_pact.given("scheduled exports exist").upon_receiving(
            ...
            "GET", "/api/v1/scheduled-exports/", query="limit=50&offset=0"
        ).will_respond_with(
            200,
            body={
                "count": 1,
        ...
        result = requests.get(
            "http://localhost:1238/api/v1/scheduled-exports/", params={"limit": 50, "offset": 0}
        )
    ...
    def test_trigger_export(self, export_pact):
        ...
        ).with_request("POST", "/api/v1/scheduled-exports/export-uuid/trigger/").will_respond_with(
            200,
            body={
                "id": Like("run-uuid"),
                "status": Like("QUEUED"),
    ...
    def test_get_run_history(self, export_pact):
        export_pact.given("export has run history").upon_receiving(
            ...
            "GET", "/api/v1/scheduled-exports/export-uuid/runs/", query="limit=20&offset=0"
        ).will_respond_with(
            200,
            body={
                "results": [
