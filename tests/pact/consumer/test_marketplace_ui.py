...
class TestMarketplaceUIContract:
    ...
    def test_list_listings(self, mkt_pact):
        mkt_pact.given("listings exist").upon_receiving(
            "browse marketplace listings"
        ).with_request("GET", "/api/v1/marketplace/listings/",
        ...
        import requests
        result = requests.get("http://localhost:1237/api/v1/marketplace/listings/",
    ...
    def test_checkout(self, mkt_pact):
        ...
        ).with_request("POST", "/api/v1/marketplace/orders/", body={
        ...
        import requests
        result = requests.post("http://localhost:1237/api/v1/marketplace/orders/", json={
    ...
    def test_entitlements(self, mkt_pact):
        ...
        ).with_request("GET", "/api/v1/marketplace/entitlements/",
        ...
        import requests
        result = requests.get("http://localhost:1237/api/v1/marketplace/entitlements/",
