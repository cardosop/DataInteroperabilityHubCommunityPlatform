...
class AuthAPIRegressionTest(APIRegressionTest):
    ...
    def test_login_endpoint(self):
        ...
        has_refresh_cookie = any("refresh_token" in str(c) for c in response.cookies.values())
    ...
    def test_api_key_create(self):
        ...
        response = self.client.post(
            "/api/v1/auth/api-keys/", {"name": "New API Key"}, format="json"
        )
        ...
        self.assertTrue(
            "api_key" in response.data or "key" in response.data,
...
class TenantAPIRegressionTest(APIRegressionTest):
    ...
    def test_tenant_create(self):
        ...
        response = self.client.post(
            "/api/v1/tenants/", {"name": "New Tenant", "slug": "new-tenant"}, format="json"
        )
...
class AssetAPIRegressionTest(APIRegressionTest):
    ...
    def setUp(self):
        ...
        self.asset = Asset.objects.create(
            tenant=self.tenant, key="test-asset", name="Test Asset", description="Test Description"
        )
    ...
    def test_asset_create(self):
        ...
        response = self.client.post(
            "/api/v1/assets/",
            {"key": "new-asset", "name": "New Asset", "description": "New Description"},
            format="json",
        )
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)
        self.assertIn("id", response.data)
    ...
    def test_asset_update(self):
        ...
        response = self.client.put(
            ...
            {"key": self.asset.key, "name": "Updated Asset", "description": "Updated Description"},
            format="json",
        )
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_asset_partial_update(self):
        ...
        response = self.client.patch(
            f"/api/v1/assets/{self.asset.id}/", {"name": "Partially Updated Asset"}, format="json"
        )
        self.assertEqual(response.status_code, status.HTTP_200_OK)

    def test_asset_delete(self):
        """Test DELETE /api/v1/assets/{id}/"""
        asset = Asset.objects.create(tenant=self.tenant, key="to-delete", name="To Delete")
...
class ContractAPIRegressionTest(APIRegressionTest):
    ...
    def setUp(self):
        super().setUp()
        self.asset = Asset.objects.create(
            tenant=self.tenant, key="contract-asset", name="Contract Asset"
        )
...
class FileAPIRegressionTest(APIRegressionTest):
    ...
    def test_file_init_upload(self):
        ...
        response = self.client.post(
            "/api/v1/files/init/",
            {"name": "new-file.csv", "content_type": "text/csv", "size": 2048},
            format="json",
        )
        self.assertEqual(
            response.status_code,
...
class JobAPIRegressionTest(APIRegressionTest):
    ...
    def test_job_create(self):
        ...
        response = self.client.post(
            "/api/v1/jobs/", {"job_type": "DQ_RUN", "input_data": {"test": "data"}}, format="json"
        )
...
class DQAPIRegressionTest(APIRegressionTest):
    ...
    def setUp(self):
        super().setUp()
        self.asset = Asset.objects.create(tenant=self.tenant, key="dq-asset", name="DQ Asset")
...
class ComplianceAPIRegressionTest(APIRegressionTest):
    ...
    def setUp(self):
        super().setUp()
        self.asset = Asset.objects.create(
            tenant=self.tenant, key="compliance-asset", name="Compliance Asset"
        )
...
class MarketplaceAPIRegressionTest(APIRegressionTest):
    ...
    def setUp(self):
        ...
        self.listing = Listing.objects.create(
            tenant=self.tenant, asset=self.asset, status=ListingStatus.DRAFT
        )
    ...
    def test_listing_create(self):
        ...
        response = self.client.post(
            ...
            {"asset_id": str(self.asset.id), "title": "New Listing"},
            format="json",
        )
        self.assertIn(response.status_code, [status.HTTP_201_CREATED, status.HTTP_400_BAD_REQUEST])
