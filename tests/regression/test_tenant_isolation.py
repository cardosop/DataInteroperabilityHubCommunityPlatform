...
class TenantDataIsolationTest(TenantIsolationRegressionTest):
    ...
    def test_asset_isolation(self):
        ...
        asset1 = Asset.objects.create(
            tenant=self.tenant1, key="tenant1-asset", name="Tenant 1 Asset"
        )
        asset2 = Asset.objects.create(
            tenant=self.tenant2, key="tenant2-asset", name="Tenant 2 Asset"
        )
    ...
    def test_contract_isolation(self):
        ...
        asset1 = Asset.objects.create(
            tenant=self.tenant1, key="contract-asset-1", name="Contract Asset 1"
        )
        asset2 = Asset.objects.create(
            tenant=self.tenant2, key="contract-asset-2", name="Contract Asset 2"
        )
    ...
    def test_file_isolation(self):
        ...
        File.objects.create(
            tenant=self.tenant1, name="tenant1-file.csv", content_type="text/csv", size=1024
        )
        file2 = File.objects.create(
            tenant=self.tenant2, name="tenant2-file.csv", content_type="text/csv", size=2048
        )
    ...
    def test_job_isolation(self):
        ...
        asset1 = Asset.objects.create(tenant=self.tenant1, key="job-asset-1", name="Job Asset 1")
        asset2 = Asset.objects.create(tenant=self.tenant2, key="job-asset-2", name="Job Asset 2")
...
class TenantConfigurationIsolationTest(TenantIsolationRegressionTest):
    ...
    def test_tenant_config_isolation(self):
        ...
        TenantConfig.objects.create(tenant=self.tenant1, default_dq_profile="intake_basic_gx")
        TenantConfig.objects.create(tenant=self.tenant2, default_dq_profile="intake_advanced_gx")
...
class CrossTenantAccessPreventionTest(TenantIsolationRegressionTest):
    ...
    def test_cross_tenant_asset_access(self):
        ...
        asset = Asset.objects.create(
            tenant=self.tenant2, key="cross-tenant-asset", name="Cross Tenant Asset"
        )
    ...
    def test_cross_tenant_file_access(self):
        ...
        file = File.objects.create(
            tenant=self.tenant2, name="cross-tenant-file.csv", content_type="text/csv", size=1024
        )
...
class TenantScopedQueriesTest(TenantIsolationRegressionTest):
    ...
    def test_tenant_scoped_contract_queries(self):
        ...
        asset1 = Asset.objects.create(
            tenant=self.tenant1, key="contract-query-asset-1", name="Contract Query Asset 1"
        )
        asset2 = Asset.objects.create(
            tenant=self.tenant2, key="contract-query-asset-2", name="Contract Query Asset 2"
        )
