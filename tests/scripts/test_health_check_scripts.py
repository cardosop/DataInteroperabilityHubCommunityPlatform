...
class TestHealthCheckScripts:
    ...
    def test_health_check_workflow_script_exists(self):
        ...
        assert os.access(HEALTH_CHECK_WORKFLOW, os.X_OK), "health-check-workflow.sh is not executable"
    ...
    def test_health_check_event_bus_script_exists(self):
        ...
        assert os.access(HEALTH_CHECK_EVENT_BUS, os.X_OK), "health-check-event-bus.sh is not executable"
    ...
    def test_health_check_service_layer_script_exists(self):
        ...
        assert os.access(HEALTH_CHECK_SERVICE_LAYER, os.X_OK), "health-check-service-layer.sh is not executable"
    ...
    def test_health_check_lib_has_required_functions(self):
        ...
        with open(HEALTH_CHECK_LIB, 'r') as f:
            content = f.read()
    ...
    def test_health_check_all_checks_all_services(self):
        ...
        with open(HEALTH_CHECK_ALL, 'r') as f:
            content = f.read()
    ...
    def test_health_check_workflow_checks_workflow_services(self):
        ...
        for service in expected_services:
            assert service in content, \
                f"health-check-workflow.sh should check {service}"
    ...
    def test_health_check_event_bus_checks_event_bus_services(self):
        ...
        with open(HEALTH_CHECK_EVENT_BUS, 'r') as f:
            content = f.read()
        ...
        for service in expected_services:
            assert service in content, \
                f"health-check-event-bus.sh should check {service}"
    ...
    def test_health_check_service_layer_checks_service_layer_services(self):
        ...
        with open(HEALTH_CHECK_SERVICE_LAYER, 'r') as f:
            content = f.read()
        ...
        for service in expected_services:
            assert service in content, \
                f"health-check-service-layer.sh should check {service}"
        ...
        for script in scripts:
            with open(script, 'r') as f:
                ...
                assert 'main()' in content, \
                    f"{script.name} should define main() function"
    ...
    def test_health_check_lib_has_color_codes(self):
        ...
        for color_code in color_codes:
            assert color_code in content, \
                f"health_check_lib.sh should define {color_code}"
        ...
        for script in scripts:
            with open(script, 'r') as f:
                ...
                assert 'FAILED' in content, \
                    f"{script.name} should track failed checks"
    ...
    def test_health_check_scripts_print_summary(self):
        ...
        for script in scripts:
            with open(script, 'r') as f:
                content = f.read()
                assert 'print_summary' in content, \
                    f"{script.name} should call print_summary"
