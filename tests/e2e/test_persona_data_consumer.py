...
class DataConsumerPersonaTest(E2ETestBase):
    ...
    def test_data_consumer_subject_to_rate_limits(self):
        ...
        allowed, _results = check_rate_limit(
            request=request,
    ...
    def test_data_consumer_cli_authentication(self):
        ...
        api_key = APIKey.objects.create(user=self.consumer_user, name="CLI Key", tenant=self.tenant)
    ...
    def test_data_consumer_rate_limit_tenant_override(self):
        ...
        self.assertTrue(
            allowed, "DATA_CONSUMER should be allowed under tenant-specific rate limits"
        )
