...
class SchemaEvolutionE2ETest(E2ETestBase):
    ...
    def test_breaking_change_workflow(self):
        ...
        VersionHistoryManager.create_version(v2, parent_version=v1, semantic_version="2.0.0", is_current=True)
        ...
        self.assertEqual(comparison.schema_diff.compatibility_level, CompatibilityLevel.FORWARD_COMPATIBLE)
    ...
    def test_time_travel_and_comparison_workflow(self):
        ...
        self.assertEqual(comparison_restored.schema_diff.compatibility_level, CompatibilityLevel.FULLY_COMPATIBLE)
