...
class Django6JSONFieldWorkflowTest(TestCase):
    ...
    def test_contract_creation_with_jsonfield(self):
        ...
        self.assertEqual(
            contract.hub_contract_json["quality"]["default_profile_key"], "great_expectations"
        )
    ...
    def test_jsonfield_query_by_tags(self):
        ...
        contract1 = Contract.objects.create(
            ...
            original_raw="{}",
            hub_contract_version="1.0.0",
            hub_contract_json={"info": {"tags": ["tag1", "tag2"]}},
            created_by=self.user,
        )
        ...
        Contract.objects.create(
            ...
            original_raw="{}",
            hub_contract_version="1.0.0",
            hub_contract_json={"info": {"tags": ["tag2", "tag3"]}},
            created_by=self.user,
        )
    ...
    def test_jsonfield_query_by_compliance_jurisdiction(self):
        ...
        contract1 = Contract.objects.create(
            ...
            original_raw="{}",
            hub_contract_version="1.0.0",
            hub_contract_json={"privacy_compliance": {"jurisdictions": ["GDPR", "CCPA"]}},
            created_by=self.user,
        )
    ...
    def test_jsonfield_query_by_quality_profile(self):
        ...
        contract1 = Contract.objects.create(
            ...
            original_raw="{}",
            hub_contract_version="1.0.0",
            hub_contract_json={"quality": {"default_profile_key": "great_expectations"}},
            created_by=self.user,
        )
        ...
        contract2 = Contract.objects.create(
            ...
            original_raw="{}",
            hub_contract_version="1.0.0",
            hub_contract_json={"quality": {"default_profile_key": "soda"}},
            created_by=self.user,
        )
...
class Django6APICompatibilityTest(TestCase):
    ...
    def test_contract_filter_api(self):
        ...
        Contract.objects.create(
            ...
            original_raw="{}",
            hub_contract_version="1.0.0",
            hub_contract_json={"info": {"tags": ["test-tag"]}},
            created_by=self.user,
        )
...
class Django6DatabaseOperationsTest(TestCase):
    ...
    def test_bulk_operations(self):
        ...
        asset = Asset.objects.create(tenant=self.tenant, key=unique_key, name="Test Asset Bulk")
