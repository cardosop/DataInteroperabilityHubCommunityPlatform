  ...
  fields:
    ...
    def test_list_contracts_with_filters(self):
        ...
        contract1 = self.create_contract(
            asset_id,
            original_raw='{"id": "contract1", "name": "Contract 1", "schema": {}}'
        )
        contract2 = self.create_contract(
            asset_id,
            original_raw='{"id": "contract2", "name": "Contract 2", "schema": {}}'
        )
    ...
    def test_update_contract(self):
        ...
        contract_id = self.create_contract(
            asset_id,
            original_raw='{"id": "test", "name": "Original Name", "schema": {}}'
        )
    ...
    def test_validate_invalid_contract(self):
        ...
        contract_id = self.create_contract(
            asset_id,
            original_raw='{"invalid": "json", "missing": "required fields"}'
        )
...
schema:
  fields: []"""
    ...
    def test_contract_normalization_failure_handling(self):
        ...
        contract_id = self.create_contract(
            asset_id,
            original_raw='{"invalid": "contract", "cannot": "normalize"}'
        )
