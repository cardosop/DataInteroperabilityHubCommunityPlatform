...
{"id": 2, "user": {"name": "Bob", "email": "bob@example.com"}, "age": 25}'''
    ...
    def test_schema_inference_with_mixed_types(self):
        ...
        if value_field:
            ...
            pytest.skip("Value field not found in schema - inference may not handle mixed types")
    ...
    def test_schema_inference_parquet_format(self):
        ...
        pass  # Placeholder - requires Parquet file generation
