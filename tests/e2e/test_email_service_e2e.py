...
class EmailServiceE2ETest(E2ETestBase):
    ...
    @override_settings(
        EMAIL_BACKEND='smtp', SMTP_HOST='localhost', SMTP_PORT=587,
        SMTP_FROM_EMAIL='noreply@example.com', EMAIL_JOB_NOTIFICATIONS_ENABLED=True
    )
    ...
    def test_job_completion_signal_triggers_email(self):
        ...
        self.assertIsNotNone(delivery,
                             "Job completion should create an EmailDelivery record")
    ...
    def test_email_delivery_tracking_journey(self):
        ...
        self.assertIn('delivery_id', result,
                       "send_email_async must return a delivery_id")
    ...
    def test_email_retry_journey(self):
        ...
        self.assertIn('delivery_id', result,
                       "send_email_async must return a delivery_id even on failure")
    ...
    def test_email_delivery_metadata_storage(self):
        ...
        self.assertIsNotNone(delivery.metadata_json,
                             "Metadata should be stored on delivery")
    ...
    def test_email_delivery_edge_case_no_user(self):
        ...
        self.assertIn('delivery_id', result,
                       "send_email_async must return a delivery_id even without user")
    ...
    def test_email_delivery_edge_case_no_tenant(self):
        ...
        self.assertIn('delivery_id', result,
                       "send_email_async must return a delivery_id even without tenant")
    ...
    def test_email_delivery_query_by_status(self):
        ...
        EmailDelivery.objects.create(
            email_type=EmailType.USER_INVITATION, to_email='pending@example.com',
            subject='Test', status=EmailDeliveryStatus.PENDING
        )
        EmailDelivery.objects.create(
            email_type=EmailType.USER_INVITATION, to_email='sent@example.com',
            subject='Test', status=EmailDeliveryStatus.SENT
        )
        EmailDelivery.objects.create(
            email_type=EmailType.USER_INVITATION, to_email='failed@example.com',
            subject='Test', status=EmailDeliveryStatus.FAILED
        )
    ...
    def test_email_delivery_query_by_type(self):
        ...
        EmailDelivery.objects.create(
            email_type=EmailType.USER_INVITATION, to_email='invitation@example.com',
            subject='Test', status=EmailDeliveryStatus.SENT
        )
        EmailDelivery.objects.create(
            email_type=EmailType.PASSWORD_RESET, to_email='reset@example.com',
            subject='Test', status=EmailDeliveryStatus.SENT
        )
        EmailDelivery.objects.create(
            email_type=EmailType.JOB_COMPLETION, to_email='job@example.com',
            subject='Test', status=EmailDeliveryStatus.SENT
        )
