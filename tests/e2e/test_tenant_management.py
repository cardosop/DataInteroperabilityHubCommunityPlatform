...
class TenantManagementE2ETest(E2ETestBase):
    ...
    def test_create_tenant_success(self):
        ...
        response = self.client.post(
            "/api/v1/tenants/",
            {"name": "New Test Tenant", "slug": "new-test-tenant", "region": "us-east-1"},
            format="json",
        )
        ...
        self.verify_audit_log(
            action="TENANT_CREATED", resource_type="TENANT", resource_id=tenant.id, result="SUCCESS"
        )
    ...
    def test_create_tenant_duplicate_slug_fails(self):
        ...
        response = self.client.post(
            "/api/v1/tenants/",
            {"name": "Second Tenant", "slug": "duplicate-slug", "region": "us-east-1"},
            format="json",
        )
    ...
    def test_update_tenant_success(self):
        ...
        response = self.client.patch(
            ...
            {"name": "Updated Name", "kyc_status": KYCStatus.VERIFIED},
            format="json",
        )
        ...
        # Verify audit log created
        self.verify_audit_log(
            action="TENANT_UPDATED", resource_type="TENANT", resource_id=tenant.id, result="SUCCESS"
        )
    ...
    def test_suspend_deleted_tenant_fails(self):
        ...
        response = self.client.post(
            f"/api/v1/tenants/{tenant.id}/suspend/", {"reason": "Test"}, format="json"
        )
    ...
    def test_delete_tenant_success(self):
        ...
        # Verify audit log created
        self.verify_audit_log(
            action="TENANT_DELETED", resource_type="TENANT", resource_id=tenant.id, result="SUCCESS"
        )
    ...
    def test_suspended_tenant_blocks_writes(self):
        ...
        suspended_user = User.objects.create_user(
            email="suspended@example.com", password="testpass123", tenant=suspended_tenant
        )
    ...
    def test_suspended_tenant_allows_reads(self):
        ...
        suspended_user = User.objects.create_user(
            email="suspended-read@example.com", password="testpass123", tenant=suspended_tenant
        )
