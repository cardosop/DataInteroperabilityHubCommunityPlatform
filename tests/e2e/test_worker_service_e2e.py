...
class WorkerServiceE2ETest(E2ETestBase):
    ...
    def test_concurrency_limit_enforcement_e2e(self):
        ...
        TenantConfigFactory.create_tenant_config(
            tenant=self.tenant, max_job_concurrency=1, max_queued_jobs=3
        )
    ...
    def test_tenant_isolation_e2e(self):
        ...
        TenantConfigFactory.create_tenant_config(
            tenant=tenant1, max_job_concurrency=1, max_queued_jobs=2
        )
        TenantConfigFactory.create_tenant_config(
            tenant=tenant2, max_job_concurrency=3, max_queued_jobs=5
        )
