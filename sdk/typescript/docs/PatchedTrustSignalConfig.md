...
**name** | **string** | Unique name within tenant (e.g. quality_verified, sla_99) | [optional] [default to undefined]
**kind** | **string** | Type: badge or quality_sla  * &#x60;badge&#x60; - Badge * &#x60;quality_sla&#x60; - Quality SLA | [optional] [default to undefined]
...
```typescript
import { PatchedTrustSignalConfig } from './api';

const instance: PatchedTrustSignalConfig = {
    id,
    tenant_id,
    name,
    kind,
