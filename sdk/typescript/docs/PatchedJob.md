...
**resource_type** | **string** | Resource type: CONTRACT, DATASET, FILE, ASSET, etc. | [optional] [default to undefined]
**resource_id** | **string** | ID of the resource this job operates on | [optional] [default to undefined]
...
```typescript
import { PatchedJob } from './api';

const instance: PatchedJob = {
    id,
    tenant,
    type,
    status,
