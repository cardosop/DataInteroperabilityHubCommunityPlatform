...
|------------- | ------------- | -------------|
|[**filesChunksInitCreate**](#fileschunksinitcreate) | **POST** /api/v1/files/{id}/chunks/init/ | |
|[**filesCompleteCreate**](#filescompletecreate) | **POST** /api/v1/files/{id}/complete/ | |
|[**filesCreate**](#filescreate) | **POST** /api/v1/files/ | |
|[**filesDestroy**](#filesdestroy) | **DELETE** /api/v1/files/{id}/ | |
|[**filesDownloadRetrieve**](#filesdownloadretrieve) | **GET** /api/v1/files/{id}/download/ | |
|[**filesInitCreate**](#filesinitcreate) | **POST** /api/v1/files/init/ | |
|[**filesList**](#fileslist) | **GET** /api/v1/files/ | |
|[**filesPartialUpdate**](#filespartialupdate) | **PATCH** /api/v1/files/{id}/ | |
|[**filesRetrieve**](#filesretrieve) | **GET** /api/v1/files/{id}/ | |
|[**filesUpdate**](#filesupdate) | **PUT** /api/v1/files/{id}/ | |

# **filesChunksInitCreate**
> any filesChunksInitCreate(modelFile)

Initialize chunk upload (for multipart uploads).  POST /files/{id}/chunks/init Body: {     \"chunk_number\": 1,     \"chunk_size\": 5242880 }  Returns pre-signed URL for uploading the chunk.
...
let id: string; //A UUID string identifying this file. (default to undefined)
...
const { status, data } = await apiInstance.filesChunksInitCreate(
    id,
    modelFile,
    idempotencyKey
);
...
|------------- | ------------- | ------------- | -------------|
| **modelFile** | **ModelFile**|  | |
| **id** | [**string**] | A UUID string identifying this file. | defaults to undefined|
...
# **filesCompleteCreate**
> any filesCompleteCreate(modelFile)

Complete file upload.  POST /files/{id}/complete Body: {     \"content_sha256\": \"abc123...\",     \"parts\": [{\"ETag\": \"...\", \"PartNumber\": 1}, ...]  # For multipart only }  Verifies file upload and calculates SHA-256 hash.
...
const { status, data } = await apiInstance.filesCompleteCreate(
    id,
    modelFile,
    idempotencyKey
);
...
ViewSet for file management.  Tenant-scoped: users can only see/manage files in their tenant. List supports: search (name), filter (status), ordering (29.69.2).
...
Delete a file.  DELETE /files/{id}  Soft deletes file record and removes from storage. Delegates to FileService.
...
Get download URL for file.  GET /files/{id}/download  Returns pre-signed download URL.  117B.6: Cross-tenant entitlement check on download.
...
# **filesInitCreate**
> any filesInitCreate(modelFile)

Initialize file upload.  POST /files/init Body: {     \"name\": \"data.csv\",     \"content_type\": \"text/csv\",     \"size\": 1024000,     \"upload_method\": \"browser\" | \"sdk\" }  Returns pre-signed URL for direct S3 upload.
...
const { status, data } = await apiInstance.filesInitCreate(
    modelFile,
    idempotencyKey
);
```
