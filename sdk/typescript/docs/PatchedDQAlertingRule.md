...
**metric_type** | **string** | Type of metric (e.g., quality_score, completeness, accuracy) | [optional] [default to undefined]
**threshold** | **number** | Threshold value (e.g., quality_score &lt; 0.9) | [optional] [default to undefined]
...
```typescript
import { PatchedDQAlertingRule } from './api';

const instance: PatchedDQAlertingRule = {
    id,
    tenant,
    asset_id,
    name,
