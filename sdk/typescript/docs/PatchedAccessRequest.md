...
**reason** | **string** | Reason for access request | [optional] [default to undefined]
**requested_access_type** | **string** | Type of access requested (e.g., \&#39;READ\&#39;, \&#39;WRITE\&#39;, \&#39;DOWNLOAD\&#39;) | [optional] [default to undefined]
...
```typescript
import { PatchedAccessRequest } from './api';

const instance: PatchedAccessRequest = {
    id,
    tenant,
    requested_by,
    asset,
