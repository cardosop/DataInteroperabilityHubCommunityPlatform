...
**name** | **string** | Webhook name/description | [optional] [default to undefined]
**url** | **string** | Webhook delivery URL | [optional] [default to undefined]
**secret** | **string** | Webhook secret for HMAC signature | [optional] [default to undefined]
...
```typescript
import { PatchedWebhook } from './api';
