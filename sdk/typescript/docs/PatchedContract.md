...
**original_spec_type** | **string** | Original spec type: ODCS (Open Data Contract Standard) or ODPS (Open Data Product Standard)  * &#x60;ODCS&#x60; - ODCS * &#x60;ODPS&#x60; - ODPS | [optional] [default to undefined]
**original_spec_version** | **string** | Original spec version (e.g., 3.0.2, 2.2.2) | [optional] [default to undefined]
**original_format** | **string** | Original format: JSON or YAML  * &#x60;JSON&#x60; - JSON * &#x60;YAML&#x60; - YAML | [optional] [default to undefined]
**original_raw** | **string** | Original contract file content (verbatim) | [optional] [default to undefined]
...
```typescript
import { PatchedContract } from './api';
