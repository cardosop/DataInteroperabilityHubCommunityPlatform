...
**profile_key** | **string** | DQ profile key (e.g., intake_basic_gx, intake_basic_soda) | [default to undefined]
**engine** | **string** | DQ engine used: GREAT_EXPECTATIONS or SODA  * &#x60;GREAT_EXPECTATIONS&#x60; - Great Expectations * &#x60;SODA&#x60; - Soda | [default to undefined]
...
```typescript
import { DQRun } from './api';

const instance: DQRun = {
    id,
    tenant,
    asset,
    dataset,
