...
**tenant** | **string** | Tenant this scheduled export belongs to | [optional] [readonly] [default to undefined]
**tenant_name** | **string** |  | [optional] [readonly] [default to undefined]
**name** | **string** | Scheduled export name (unique per tenant) | [default to undefined]
**schedule_config** | **any** | Schedule configuration (cron expression, timezone) | [default to undefined]
**destination_type** | **string** | Destination type: S3, GCS, AZURE_BLOB  * &#x60;S3&#x60; - Amazon S3 * &#x60;GCS&#x60; - Google Cloud Storage * &#x60;AZURE_BLOB&#x60; - Azure Blob Storage | [default to undefined]
**destination_config** | **any** | Destination configuration (connection details, credentials, paths) stored securely. Credentials are masked in API and logs. | [default to undefined]
**source_scope** | **any** | Source scope: asset_ids, dataset_ids, file_ids, or contract_id | [default to undefined]
...
```typescript
import { ScheduledExportCreate } from './api';

const instance: ScheduledExportCreate = {
    id,
    tenant,
    tenant_name,
    name,
