...
**direction** | **string** | Sync direction: PUSH, PULL, or BIDIRECTIONAL  * &#x60;PUSH&#x60; - Push * &#x60;PULL&#x60; - Pull * &#x60;BIDIRECTIONAL&#x60; - Bidirectional | [default to undefined]
...
```typescript
import { MarketplaceSyncJob } from './api';

const instance: MarketplaceSyncJob = {
    id,
    tenant,
    tenant_name,
    connection_id,
