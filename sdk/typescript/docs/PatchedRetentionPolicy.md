...
**name** | **string** | Policy name | [optional] [default to undefined]
...
**policy_type** | **string** | Policy type: TIME_BASED or EVENT_BASED  * &#x60;TIME_BASED&#x60; - Time-Based * &#x60;EVENT_BASED&#x60; - Event-Based | [optional] [default to undefined]
...
```typescript
import { PatchedRetentionPolicy } from './api';

const instance: PatchedRetentionPolicy = {
    id,
    tenant,
    name,
    description,
