...
**name** | **string** | Human-readable label for the endpoint (e.g. \&#39;partner-X\&#39;). | [default to undefined]
**endpoint_url** | **string** | Canonical SPARQL endpoint URL.  Compared against SERVICE clauses in incoming queries by exact-match (after scheme + host + path normalisation). | [default to undefined]
...
```typescript
import { TenantSparqlEndpoint } from './api';

const instance: TenantSparqlEndpoint = {
    id,
    name,
    endpoint_url,
    is_active,
