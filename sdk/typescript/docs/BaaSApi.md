...
|[**baasUsageByEndpointList**](#baasusagebyendpointlist) | **GET** /api/v1/baas/usage/by-endpoint/ | Get usage by endpoint|
|[**baasUsageByTenantRetrieve**](#baasusagebytenantretrieve) | **GET** /api/v1/baas/usage/by-tenant/ | Get usage by tenant|
|[**baasUsageStatsRetrieve**](#baasusagestatsretrieve) | **GET** /api/v1/baas/usage/stats/ | Get usage statistics|
...
# **baasUsageByEndpointList**
> PaginatedUsageByEndpointList baasUsageByEndpointList()

Get usage breakdown by endpoint with filtering options.
...
const { status, data } = await apiInstance.baasUsageByEndpointList(
    page,
    pageSize
);
```
...
# **baasUsageByTenantRetrieve**
> baasUsageByTenantRetrieve()

Get usage breakdown by tenant with filtering options (admin only).
...
const { status, data } = await apiInstance.baasUsageByTenantRetrieve();
```
...
# **baasUsageStatsRetrieve**
> UsageStats baasUsageStatsRetrieve()

Get aggregated usage statistics with filtering options.
...
const { status, data } = await apiInstance.baasUsageStatsRetrieve();
```
