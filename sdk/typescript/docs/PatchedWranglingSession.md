...
**name** | **string** | Session name | [optional] [default to undefined]
...
```typescript
import { PatchedWranglingSession } from './api';

const instance: PatchedWranglingSession = {
    id,
    name,
    description,
    asset_id,
