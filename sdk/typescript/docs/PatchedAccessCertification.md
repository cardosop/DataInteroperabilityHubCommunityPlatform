...
**user** | **string** | User being certified | [optional] [default to undefined]
...
**certification_type** | **string** | Type of certification  * &#x60;USER_LEVEL&#x60; - User Level * &#x60;ASSET_LEVEL&#x60; - Asset Level * &#x60;DATASET_LEVEL&#x60; - Dataset Level | [optional] [default to undefined]
...
**expires_at** | **string** | Certification expiration date | [optional] [default to undefined]
...
```typescript
import { PatchedAccessCertification } from './api';

const instance: PatchedAccessCertification = {
    id,
    tenant,
    user,
    asset,
