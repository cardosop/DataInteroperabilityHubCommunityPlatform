...
**test_connection** | **boolean** | Test source connection before creating scheduled ingestion | [optional] [default to true]

## Example

```typescript
import { ScheduledIngestionCreate } from './api';

const instance: ScheduledIngestionCreate = {
    id,
    tenant,
    tenant_name,
    name,
