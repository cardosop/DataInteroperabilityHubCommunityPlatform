...
**name** | **string** | Short, URL-safe name used as the Fuseki named-graph suffix (&#x60;&#x60;urn:tenant:{id}:ontology:{name}&#x60;&#x60;). MUST be unique per tenant. | [optional] [default to undefined]
**namespace_iri** | **string** | The ontology\&#39;s declared namespace IRI (the prefix used in tenant SPARQL queries). MUST be unique per tenant and MUST NOT collide with the reserved Meshant namespace &#x60;&#x60;https://meshant.com/ontology/&#x60;&#x60;. | [optional] [default to undefined]
...
**rdf_content** | **string** | Raw uploaded RDF body. Capped at 10 MB by the validator. | [optional] [default to undefined]
...
```typescript
import { PatchedTenantOntology } from './api';

const instance: PatchedTenantOntology = {
    id,
    name,
    namespace_iri,
    format,
