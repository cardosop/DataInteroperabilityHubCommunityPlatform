...
def internal_pipeline_config(request: HttpRequest, direction: str, resource_id: str) -> JsonResponse:
    """
    ...
    try:
        ...
        logger.error("internal_pipeline_config_failed", direction=direction, resource_id=resource_id, error=str(e))
