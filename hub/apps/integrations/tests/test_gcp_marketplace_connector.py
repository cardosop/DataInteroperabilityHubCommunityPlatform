...
class TestGCPMarketplaceConnectorCredentials(TestCase):
    ...
    @patch('hub.apps.integrations.connectors.gcp_marketplace_connector.service_account.Credentials.from_service_account_info')
...
class TestGCPMarketplaceConnectorClients(TestCase):
    ...
    @patch('hub.apps.integrations.connectors.gcp_marketplace_connector.GCPMarketplaceConnector._get_credentials')
...
class TestGCPMarketplaceConnectorAuthentication(TestCase):
    ...
    @patch('hub.apps.integrations.connectors.gcp_marketplace_connector.GCPMarketplaceConnector.test_connection')
