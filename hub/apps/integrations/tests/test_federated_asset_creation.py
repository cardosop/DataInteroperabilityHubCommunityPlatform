...
from hub.apps.integrations.base import (
    MarketplaceType, SyncDirection, SyncStatus, MarketplaceAssetMapping,
    MarketplaceResource, AssetSourceType
)
from hub.apps.assets.models import Asset, AssetStatus, AssetVisibility, AssetSourceType, ExternalResourceReference
...
class TestFederatedAssetCreation(TestCase):
    ...
    def test_create_federated_asset_with_dual_contracts(self):
        ...
        self.assertEqual(
            odps_hub_contract['extensions']['x_odps']['odcs_link'],
        ...
        self.assertEqual(
            odcs_hub_contract['extensions']['x_odps']['odps_link'],
    ...
    def test_create_federated_asset_source_metadata_enrichment(self):
        ...
        self.assertEqual(asset.source_metadata['connection_id'], str(self.connection.id))
        self.assertEqual(asset.source_metadata['sync_job_id'], str(self.sync_job.id))
        self.assertEqual(asset.source_metadata['marketplace_type'], MarketplaceType.CKAN_INSTANCE.value)
    ...
    def test_metadata_first_creation_no_downloads(self):
        ...
        self.assertIsNotNone(odps_contract.hub_contract_json.get('extensions', {}).get('x_odps', {}).get('odcs_link'))
        self.assertIsNotNone(odcs_contract.hub_contract_json.get('extensions', {}).get('x_odps', {}).get('odps_link'))
    ...
    def test_selective_download_strategy(self):
        ...
        asset_mapping = MarketplaceAssetMapping(
            asset_data={
                'name': 'Selective Download Asset',
                'key': 'selective-download-key'
            },
            source_type=AssetSourceType.FEDERATED,
            source_metadata={
                'marketplace_type': MarketplaceType.CKAN_INSTANCE.value,
        ...
        try:
            ...
            self.assertTrue(asset.can_download_resource('res-2'))  # Exists in ExternalResourceReference
    ...
    def test_odps_contract_minimal_metadata(self):
        ...
        hub_contract = odps_contract.hub_contract_json
        self.assertTrue(
            'marketplace' in hub_contract.get('extensions', {}).get('x_marketplace', {}) or
            'marketplace' in hub_contract or
            'x_odps' in hub_contract.get('extensions', {})
        )
    ...
    def test_odcs_contract_schema_hints(self):
        ...
        asset_mapping = MarketplaceAssetMapping(
            asset_data={
                'name': 'Schema Hints Asset',
                'key': 'schema-hints-key'
            },
            source_type=AssetSourceType.FEDERATED,
            source_metadata={
                'marketplace_type': MarketplaceType.CKAN_INSTANCE.value,
    ...
    def test_full_download_strategy(self):
        ...
        asset_mapping = MarketplaceAssetMapping(
            asset_data={
                'name': 'Full Download Asset',
                'key': 'full-download-key'
            },
            source_type=AssetSourceType.FEDERATED,
            source_metadata={
                'marketplace_type': MarketplaceType.CKAN_INSTANCE.value,
