...
class TestDadosGovBrAPIClient:
    ...
    def test_init_with_base_url_and_token(self):
        ...
        client = DadosGovBrAPIClient(base_url="https://dados.gov.br", jwt_token="test-token-123")
        ...
        mock_spec = {
            ...
            "paths": {
                "/api/3/action/package_search": {
                    "get": {"operationId": "package_search", "summary": "Search packages"}
                }
            },
        }

        client = DadosGovBrAPIClient(base_url="https://dados.gov.br", jwt_token="test-token")
    ...
    def test_get_endpoint_path_from_swagger_spec(self):
        ...
        mock_spec = {
            "paths": {"/api/3/action/package_search": {"get": {"operationId": "package_search"}}}
        }
    ...
    def test_request_includes_bearer_token(self):
        ...
        with patch("httpx.Client") as mock_client_class:
            ...
            client = DadosGovBrAPIClient(
                base_url="https://dados.gov.br", jwt_token="test-jwt-token-123"
            )
    ...
    def test_search_datasets_with_filters(self):
        ...
        with patch.object(client, "_request") as mock_request:
            ...
            result = client.search_datasets(
                query="test", filters={"idOrganizacao": "test-org"}, page=1
            )
    ...
    def test_get_dataset_by_id(self):
        ...
        mock_response_data = {
            "success": True,
            "result": {"id": "test-dataset", "name": "Test Dataset", "title": "Test Dataset Title"},
        }
    ...
    def test_get_dataset_tags(self):
        ...
        with patch.object(client, "_request") as mock_request:
            ...
            mock_request.assert_called_once_with(
                "GET", "/dados/api/publico/conjuntos-dados/test-dataset/tag"
            )
    ...
    def test_list_organizations(self):
        ...
        with patch.object(client, "_request") as mock_request:
            ...
            assert result == mock_response_data
            mock_request.assert_called_once_with(
                "GET", "/dados/api/publico/organizacao", params={"pagina": 1}
            )
