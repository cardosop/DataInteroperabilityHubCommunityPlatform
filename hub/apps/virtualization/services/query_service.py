...
class QueryServiceMixin:
    """Mixin providing query execution and result management."""
    ...
    def _normalise_query_params(
        ...
        if not use_parameterised:
            return QueryServiceMixin._apply_parameters_legacy(query, parameters), ()
    ...
    def get_topology(
        ...
        for dataset in datasets:
            _ds = dataset.get_sources()
            sources_list = _ds if _ds and isinstance(_ds, list) else []
