...
class VersionHistoryIntegrationTest(TestCase):
    ...
    def test_version_querying_integration(self):
        ...
        VersionHistoryManager.create_version(v1, semantic_version="1.0.0", version_tags=["production"], is_current=False)
        ...
        VersionHistoryManager.create_version(v2, parent_version=v1, semantic_version="1.1.0", version_tags=["staging"], is_current=True)
