...
class VersionComparisonServiceTest(DatasetsTestBase):
    ...
    def test_compare_versions_no_changes(self):
        ...
        self.assertEqual(
            comparison.schema_diff.compatibility_level, CompatibilityLevel.FULLY_COMPATIBLE
        )
    ...
    def test_visualize_schema_diff_json(self):
        ...
        self.assertEqual(
            visualization["compatibility_level"], CompatibilityLevel.BACKWARD_COMPATIBLE.value
        )
    ...
    def test_version_comparison_success(self):
        """Test successful version comparison (success scenario)"""
        v1 = Dataset.objects.create(
            tenant=self.tenant,
            asset=self.asset,
            file=self.file,
    ...
    def test_version_comparison_edge_case_no_changes(self):
        """Test version comparison with no changes (edge case)"""
        v1 = Dataset.objects.create(
            tenant=self.tenant,
            asset=self.asset,
            file=self.file,
    ...
    def test_version_comparison_edge_case_empty_schemas(self):
        """Test version comparison with empty schemas (edge case)"""
        v1 = Dataset.objects.create(
            tenant=self.tenant,
            asset=self.asset,
            file=self.file,
