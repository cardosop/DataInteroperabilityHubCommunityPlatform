            ...
            for contract in contracts:
                if str(contract.id) not in self.visited_contracts:
                    ...
                    contract_node = VersionImpactNode(
                        ...
                        resource_name=contract.hub_contract_json.get("info", {}).get("name", "Unnamed Contract") if isinstance(contract.hub_contract_json, dict) else "Unnamed Contract",
                        depth=depth + 2,
