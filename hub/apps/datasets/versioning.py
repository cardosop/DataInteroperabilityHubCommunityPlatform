...
class VersionHistoryManager:
    ...
    def create_version(
        ...
        dataset.semantic_version = semantic_version or VersionHistoryManager._infer_semantic_version(
    ...
    @staticmethod
    def _parse_semantic_version(version_str: str) -> Optional[Tuple[int, int, int]]:
    ...
    @staticmethod
    def _has_metadata_only_changes(
        old_dataset: Dataset,
        new_dataset: Dataset
    ) -> bool:
        """
    ...
    @staticmethod
    def get_current_version(asset_id: UUID, tenant_id: UUID) -> Optional[Dataset]:
        """
    ...
    @staticmethod
    def archive_version(dataset: Dataset, archived_at: Optional[datetime] = None) -> Dataset:
        """
