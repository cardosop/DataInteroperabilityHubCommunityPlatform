...
class SearchServiceEventIntegrationTest(TestCase):
    ...
    def test_search_publishes_search_query_event(self):
        ...
        # Perform search
        _results, total = self.service.search(
    ...
    def test_search_publishes_event_with_filters(self):
        ...
        _results, _total = self.service.search(
    ...
    def test_rebuild_index_publishes_index_rebuilt_event(self):
        ...
        Asset.objects.create(tenant=self.tenant, name="Test Asset", created_by=self.user)
        ...
        # Rebuild index
        self.service.rebuild_index(tenant_id=str(self.tenant.id), user_id=str(self.user.id))
