...
class AccessRequestViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request):
        ...
        if not tenant:
            return Response(
                {'error': 'User must belong to a tenant to create access requests'},
        ...
        try:
            ...
            return Response(
                {'error': f'Failed to create access request: {str(e)}'},
    ...
    def approve(self, request, id=None):
        ...
        try:
            ...
            return Response(
                {'error': f'Failed to approve access request: {str(e)}'},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR
            )
    ...
    def reject(self, request, id=None):
        ...
        try:
            ...
            return Response(
                {'error': f'Failed to reject access request: {str(e)}'},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR
            )
