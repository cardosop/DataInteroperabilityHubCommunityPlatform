...
class AccessAnalyticsViewSet(viewsets.ViewSet):
    ...
    def _get_tenant_id(self, request):
        """Get tenant ID from request using central helper (Phase 10.1.6)"""
...
class AccessCertificationViewSet(viewsets.ModelViewSet):
    ...
    def summary(self, request):
        ...
        summary = AccessCertificationService.get_certification_summary(tenant_id=tenant_id)
    ...
    def initiate_review(self, request):
        ...
        certification = AccessCertificationService.initiate_periodic_review(
            tenant_id=tenant_id, user_id=user_id, reviewer_id=reviewer_id
        )
