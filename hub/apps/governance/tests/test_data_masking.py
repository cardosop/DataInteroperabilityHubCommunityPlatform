...
class DataMaskerTest(TestCase):
    ...
    def test_mask_based_on_classification(self):
        ...
        value = "user@example.com"
        masked = DataMasker.mask_based_on_classification(value, ClassificationCategory.PII)
        self.assertNotEqual(masked, value)
        self.assertIn("@", masked)

        # RESTRICTED should use redact
        masked = DataMasker.mask_based_on_classification(value, ClassificationCategory.RESTRICTED)
        self.assertEqual(masked, "***REDACTED***")

        # PUBLIC should not mask
        masked = DataMasker.mask_based_on_classification(value, ClassificationCategory.PUBLIC)
