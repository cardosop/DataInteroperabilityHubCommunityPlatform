...
class ComplianceReportGeneratorTest(TestCase):
    ...
    def test_generate_gdpr_report(self):
        ...
        # Generate report
        report = ComplianceReportGenerator.generate_gdpr_report(tenant_id=str(self.tenant.id))
    ...
    def test_generate_hipaa_report(self):
        ...
        # Generate report
        report = ComplianceReportGenerator.generate_hipaa_report(tenant_id=str(self.tenant.id))
    ...
    def test_generate_sox_report(self):
        ...
        # Generate report
        report = ComplianceReportGenerator.generate_sox_report(tenant_id=str(self.tenant.id))
    ...
    def test_generate_lgpd_report(self):
        ...
        # Generate report
        report = ComplianceReportGenerator.generate_lgpd_report(tenant_id=str(self.tenant.id))
    ...
    def test_generate_ccpa_report(self):
        ...
        # Generate report
        report = ComplianceReportGenerator.generate_ccpa_report(tenant_id=str(self.tenant.id))
