...
class DataClassifierTest(TestCase):
    ...
    def test_classify_field_email(self):
        ...
        result = DataClassifier.classify_field(
            field_name="email", sample_values=["user@example.com", "admin@test.com"]
        )
    ...
    def test_classify_field_phone(self):
        ...
        result = DataClassifier.classify_field(
            field_name="phone_number", sample_values=["123-456-7890", "+1-555-123-4567"]
        )
    ...
    def test_classify_field_ssn(self):
        ...
        result = DataClassifier.classify_field(field_name="ssn", sample_values=["123-45-6789"])
    ...
    def test_classify_field_credit_card(self):
        ...
        result = DataClassifier.classify_field(
            field_name="credit_card", sample_values=["1234-5678-9012-3456"]
        )
    ...
    def test_classify_field_financial(self):
        ...
        result = DataClassifier.classify_field(
            field_name="salary", sample_values=["50000", "75000"]
        )
    ...
    def test_classify_field_default(self):
        ...
        result = DataClassifier.classify_field(
            field_name="unknown_field", sample_values=["value1", "value2"]
        )
    ...
    def test_classify_dataset(self):
        ...
        classifications = DataClassifier.classify_dataset(
            tenant_id=str(self.tenant.id), dataset_id=str(dataset.id), user_id=str(self.user.id)
        )
    ...
    def test_classify_asset(self):
        ...
        classifications = DataClassifier.classify_asset(
            tenant_id=str(self.tenant.id), asset_id=str(self.asset.id), user_id=str(self.user.id)
        )
