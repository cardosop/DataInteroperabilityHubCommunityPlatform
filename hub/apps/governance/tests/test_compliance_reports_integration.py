...
class ComplianceReportIntegrationTest(TestCase):
    ...
    def test_gdpr_report_with_full_data(self):
        ...
        # Classify fields
        DataClassifier.classify_dataset(
        ...
        AccessRequestWorkflow.create_access_request(
            tenant_id=str(self.tenant.id),
    ...
    def test_scheduled_report_generation(self):
        ...
        # The freshly scheduled report may be immediately due,
        # so generated ≥ 1 is expected.  Verify at minimum the
        # count is a non-negative integer and the scheduling
        # didn't error.
        self.assertIsInstance(results["generated"], int)
