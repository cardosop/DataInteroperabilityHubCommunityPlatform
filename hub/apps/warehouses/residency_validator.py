...
_REGION_TO_ISO: dict[str, str] = {
    ...
    "ap-southeast-3": "MY", "ap-southeast-4": "AU",
    ...
    "europe-north1": "FI", "europe-central2": "PL",
    ...
    "southindia": "IN", "centralindia": "IN", "westindia": "IN",
...
_TENANT_REGION_ALLOWLIST: dict[str, set[str]] = {
    ...
    "eu-west-1": {"IE", "GB", "FR", "DE", "CH", "SE", "IT", "ES", "NL",
                   "FI", "PL", "BE", "NO", "PT", "AT", "DK", "GR", "CZ",
                   "RO", "HU", "SK", "BG", "HR", "SI", "LT", "LV", "EE",
                   "IS", "LI", "LU", "MT", "CY"},
    "eu": {"IE", "GB", "FR", "DE", "CH", "SE", "IT", "ES", "NL",
           "FI", "PL", "BE", "NO", "PT", "AT", "DK", "GR", "CZ",
           "RO", "HU", "SK", "BG", "HR", "SI", "LT", "LV", "EE",
           "IS", "LI", "LU", "MT", "CY"},
...
def find_residency_mismatches() -> list[dict]:
    ...
    for conn in WarehouseConnection.objects.select_related("tenant").filter(
        is_active=True,
    ).exclude(region=""):
        tenant = conn.tenant
