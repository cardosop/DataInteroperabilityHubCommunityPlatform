...
class EmailType(models.TextChoices):
    ...
    MARKETPLACE_CONNECTION_TEST_FAILURE = (
        "MARKETPLACE_CONNECTION_TEST_FAILURE",
        "Marketplace Connection Test Failure",
    )
...
class EmailDelivery(models.Model):
    ...
    delivered_at = models.DateTimeField(
        null=True, blank=True, help_text="When email was delivered (from webhook)"
    )
    failed_at = models.DateTimeField(null=True, blank=True, help_text="When email delivery failed")
    created_at = models.DateTimeField(
        auto_now_add=True, help_text="When email delivery record was created"
    )
    updated_at = models.DateTimeField(
        auto_now=True, help_text="When email delivery record was last updated"
    )
    ...
    def can_retry(self) -> bool:
        ...
        return (
            self.status in [EmailDeliveryStatus.FAILED, EmailDeliveryStatus.DEFERRED]
