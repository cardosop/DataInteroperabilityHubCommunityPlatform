...
class CheckLimitWarningTest(TestCase):
    ...
    def test_no_warning_below_80_percent(self):
        ...
        with patch("hub.apps.billing.limit_registry.get_resource_count", return_value=7):
    ...
    def test_warning_at_80_percent_exactly(self):
        ...
        with patch("hub.apps.billing.limit_registry.get_resource_count", return_value=8):
            result = self.service.check_limit(
                str(self.tenant.id),
                "max_assets",
                delta=0,
    ...
    def test_warning_above_80_percent(self):
        ...
        with patch("hub.apps.billing.limit_registry.get_resource_count", return_value=9):
            result = self.service.check_limit(
                str(self.tenant.id),
                "max_assets",
                delta=0,
    ...
    def test_no_warning_for_unlimited_plan(self):
        ...
        with patch("hub.apps.billing.limit_registry.get_resource_count", return_value=9999):
            result = self.service.check_limit(
                str(tenant.id),
                "max_assets",
                delta=0,
    ...
    def test_delta_included_in_percent_calculation(self):
        ...
        with patch("hub.apps.billing.limit_registry.get_resource_count", return_value=6):
    ...
    def test_hard_limit_still_blocks_at_100_percent(self):
        ...
        with patch("hub.apps.billing.limit_registry.get_resource_count", return_value=10):
