...
class DataExportJobModelTest(TestCase):
    ...
    def test_create_data_export_job_success(self):
        ...
        # FK and default-value assertions (id / created_at / updated_at are
        # auto-generated by the ORM — asserting not-None on them is tautological)
...
class ErasureRequestModelTest(TestCase):
    ...
    def test_create_erasure_request_success(self):
        ...
        # FK and default-value assertions (id / requested_at / created_at /
        # updated_at are ORM auto-fields — asserting not-None is tautological)
