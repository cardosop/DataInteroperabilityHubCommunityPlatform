...
urlpatterns = [
    ...
    re_path(r'^(?!auth/|tenants/|users/|audit/|files/|datasets/|jobs/|contracts/|assets/|dq/|compliance/|semantic/|marketplace/|scheduled-ingestions/|search/|developer/|webhooks/|events/|transformation/|mesh/|virtualization/|integrations/|baas/|ml/).*$', api_not_found, name='api-not-found'),
]
