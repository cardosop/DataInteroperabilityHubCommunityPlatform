...
class APIAnalyticsServiceTest(TestCase):
    ...
    def test_get_usage_trends(self):
        ...
        trends = APIAnalyticsService.get_usage_trends(
            tenant_id=str(self.tenant.id), granularity="hour"
        )
    ...
    def test_get_performance_metrics(self):
        ...
        metrics = APIAnalyticsService.get_performance_metrics(tenant_id=str(self.tenant.id))
    ...
    def test_get_analytics_dashboard(self):
        ...
        dashboard = APIAnalyticsService.get_analytics_dashboard(tenant_id=str(self.tenant.id))
