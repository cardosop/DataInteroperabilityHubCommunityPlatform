...
from hub.apps.api.utils.api_url_builder import (
    APIURLBuilder,
    build_api_url,
    build_full_api_url
)
...
class APIURLBuilderTest(TestCase):
    ...
    def test_build_resource_with_query_params(self):
        ...
        url = self.builder.build('contracts', query_params={'format': 'json', 'include': 'metadata'})
    ...
    def test_build_full_url(self):
        ...
        url = self.builder.build_full_url('contracts', resource_id='123', base_url='http://example.com')
    ...
    def test_build_with_complex_action(self):
        ...
        url = self.builder.build(
            'contracts',
            resource_id='123',
            action='lineage-visualization-custom'
        )
