...
class ContractQualityRulesExtractor:
    ...
    @staticmethod
    def parse_rule_expression(expression: str, field_name: Optional[str] = None) -> Dict[str, Any]:
        """
    ...
    @staticmethod
    def convert_rule_to_dq_check(rule: Dict[str, Any]) -> Optional[DQCheck]:
        """
        ...
        dqv_dimension = get_dqv_dimension(dimension) if get_dqv_dimension else None
        ...
        expectation_type = expectation_type_map.get(check_type_str, 'expect_custom_expression_to_be_true')
