...
class DQAlertingServiceTest(TestCase):
    ...
    def test_evaluate_rules_threshold_not_met(self):
        ...
        # Create rule: quality_score < 80
        self._create_alerting_rule(80.0, operator="<")
    ...
    def test_evaluate_rules_multiple_rules(self):
        ...
        self._create_alerting_rule(80.0, operator="<", severity=DQAnomalySeverity.MEDIUM)
        self._create_alerting_rule(70.0, operator="<", severity=DQAnomalySeverity.HIGH)
