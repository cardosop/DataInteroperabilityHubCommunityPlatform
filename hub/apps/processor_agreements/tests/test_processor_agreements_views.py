"""
285.12.3.2 — Processor Agreement ViewSet tests.
"""
...
pytestmark = [pytest.mark.journey("JOURNEY-CPO-014")]
...
class ProcessorAgreementViewSetTests(TestCase):
    def setUp(self):
        ...
        # IsTenantAdminProcessorAgreements requires TENANT_ADMIN
