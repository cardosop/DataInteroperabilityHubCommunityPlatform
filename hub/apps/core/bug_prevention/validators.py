...
class InputValidator:
    ...
    def validate_and_raise(
        ...
        return model_class.model_validate(data, strict=strict) if strict else model_class.model_validate(data)
...
class OutputValidator:
    ...
    def validate_and_serialize(
        ...
        if isinstance(data, model_class):
            ...
            instance = model_class.model_validate(data, strict=strict) if strict else model_class.model_validate(data)
