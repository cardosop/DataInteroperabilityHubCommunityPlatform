...
class EventSchemaVersionManager:
    ...
    def validate_version(self, event_version: str) -> tuple[bool, Optional[str]]:
        """
        ...
        if event_version not in self.supported_versions:
            return False, f"Unsupported event version: {event_version}. Supported versions: {self.supported_versions}"
        return True, None
    ...
    def get_schema_for_version(self, event_type: str, version: str) -> Optional[Dict[str, Any]]:
        """
