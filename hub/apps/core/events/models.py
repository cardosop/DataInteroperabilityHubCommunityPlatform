...
class Event(models.Model):
    ...
    event_type = models.CharField(max_length=255, db_index=True, help_text="Event type (e.g., 'contract.created')")
...
class DeadLetterQueue(models.Model):
    ...
    error_details = JSONField(default=dict, blank=True, help_text="Error details (stack trace, etc.)")
...
class EventSubscription(models.Model):
    ...
    """
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    subscriber_name = models.CharField(max_length=255, db_index=True, help_text="Subscriber identifier")
    event_type_pattern = models.CharField(max_length=255, db_index=True, help_text="Event type pattern (supports wildcards)")
    is_active = models.BooleanField(default=True, db_index=True, help_text="Whether subscription is active")
