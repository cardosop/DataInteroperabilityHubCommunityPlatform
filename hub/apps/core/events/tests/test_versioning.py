...
class EventSchemaVersioningTest(TestCase):
    ...
    def test_get_schema_for_version(self):
        ...
        schema = self.version_manager.get_schema_for_version("contract.created", CURRENT_EVENT_VERSION)
    ...
    def test_is_backward_compatible_same_version(self):
        ...
        compatible = self.version_manager.is_backward_compatible(CURRENT_EVENT_VERSION, CURRENT_EVENT_VERSION)
