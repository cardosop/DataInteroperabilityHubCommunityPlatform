...
class ServiceRegistry:
    ...
    def get_service_url(cls, service_name: str, namespace: Optional[str] = None) -> str:
        """
    ...
    @classmethod
    def get_health_check_url(cls, service_name: str, namespace: Optional[str] = None) -> str:
        """
...
def get_service_url(service_name: str, namespace: Optional[str] = None) -> str:
    """Get service URL for a service."""
    return ServiceRegistry.get_service_url(service_name, namespace)


def get_health_check_url(service_name: str, namespace: Optional[str] = None) -> str:
    """Get health check URL for a service."""
