...
# Import source connectors from Prefect Integration Service
...
class ScheduledIngestionProcessor:
    ...
    def process(self) -> Dict[str, Any]:
        ...
        try:
            ...
            result = {
                ...
                "datasets_created": state_summary.get("total_processed", 0),  # Each processed file creates a dataset
                "ingestion_state": {
    ...
    def _discover_files(self) -> List[str]:
        ...
        """
        try:
            connector = SourceConnectorFactory.get_connector(self.source_type)
    ...
    def _create_asset(self) -> Asset:
        ...
        asset = Asset.objects.create(
            ...
            key=asset_key,
            name=asset_name,
            description=self.scheduled_ingestion.description or f"Asset created from scheduled ingestion {self.scheduled_ingestion.name}",
    ...
    def _format_dq_failure_message(self, dq_result: Dict[str, Any]) -> str:
        ...
        failed_checks = [
            ...
            if check.get("status", "").upper() not in ["PASS", "SUCCESS"]
        ]
    ...
    def _create_dataset(self, file_obj: File, asset: Optional[Asset] = None, file_format: str = 'CSV', dq_result: Optional[Dict[str, Any]] = None) -> Dataset:
        """
