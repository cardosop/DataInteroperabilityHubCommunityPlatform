...
class IncrementalStateManager:
    ...
    def get_last_processed_file(self) -> Optional[str]:
        """
    ...
    def should_process_file(self, file_path: str, file_timestamp: Optional[datetime] = None) -> bool:
        """
    ...
    def mark_file_processed(
        ...
        self.scheduled_ingestion.save(update_fields=[
            'last_processed_file',
    ...
    def get_state_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "last_processed_timestamp": (
                ...
                if self.get_last_processed_timestamp() else None
            ),
