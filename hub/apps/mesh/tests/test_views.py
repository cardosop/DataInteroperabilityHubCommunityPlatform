...
from hub.apps.mesh.models import DataMeshDomain, DomainStatus, PolicyApplication, PolicyApplicationStatus, ComplianceReport
...
class PolicyApplicationEndpointTest(DomainViewSetTestCase):
    ...
    def test_remove_policy_success(self):
        ...
        url = reverse('domain-remove-policy', kwargs={'id': str(self.domain.id), 'policy_id': str(self.policy.id)})
        response = self.client.delete(url)
    ...
    def test_remove_policy_not_found(self):
        ...
        url = reverse('domain-remove-policy', kwargs={'id': str(self.domain.id), 'policy_id': '00000000-0000-0000-0000-000000000000'})
        response = self.client.delete(url)
...
class ComplianceCheckEndpointTest(DomainViewSetTestCase):
    ...
    def test_get_compliance_report_success(self):
        ...
        url = reverse('domain-get-compliance-report', kwargs={'id': str(self.domain.id), 'report_id': str(report.id)})
        response = self.client.get(url)
    ...
    def test_get_compliance_report_not_found(self):
        ...
        url = reverse('domain-get-compliance-report', kwargs={'id': str(self.domain.id), 'report_id': '00000000-0000-0000-0000-000000000000'})
        response = self.client.get(url)
...
class FederatedGovernanceIntegrationTest(DomainViewSetTestCase):
    ...
    def test_full_governance_workflow(self):
        ...
        apply_response = self.client.post(apply_url, {'policy_id': str(self.policy1.id)}, format='json')
        ...
        get_report_url = reverse('domain-get-compliance-report', kwargs={'id': str(self.domain.id), 'report_id': report_id})
        ...
        remove_url = reverse('domain-remove-policy', kwargs={'id': str(self.domain.id), 'policy_id': str(self.policy1.id)})
