...
class VersionCreationWorkflow:
        ...
        workflow_dsl = {
            ...
            "steps": [
                ...
                },
                {
                    ...
                    "compensation": {
                        "type": "task",
                        "task": "version_creation.rollback_indexing"
                    }
                },
                {
                ...
                },
                {
                    "name": "audit_logging",
                    "type": "task",
                    "task": "version_creation.audit_logging"
                }
            ],
    ...
    def register_tasks(cls, engine: WorkflowEngine) -> None:
        ...
        engine.register_task(
            "version_creation.detect_schema_changes",
            cls._detect_schema_changes_task
        )
        engine.register_task(
            "version_creation.calculate_semantic_version",
            cls._calculate_semantic_version_task
        )
        engine.register_task(
            "version_creation.create_version_record",
            cls._create_version_record_task
        )
        engine.register_task(
            "version_creation.store_version_snapshot",
            cls._store_version_snapshot_task
        )
        engine.register_task(
            "version_creation.update_version_history",
            cls._update_version_history_task
        )
        engine.register_task(
            "version_creation.calculate_version_diff",
            cls._calculate_version_diff_task
        )
        engine.register_task(
            "version_creation.update_lineage_references",
            cls._update_lineage_references_task
        )
        engine.register_task(
            "version_creation.index_for_search",
            cls._index_for_search_task
        )
        engine.register_task(
            "version_creation.send_notifications",
            cls._send_notifications_task
        )
        engine.register_task(
            "version_creation.audit_logging",
            cls._audit_logging_task
        )
        
        # Compensation tasks
        engine.register_task(
            "version_creation.rollback_version_record",
            cls._rollback_version_record_task
        )
        engine.register_task(
            "version_creation.rollback_version_snapshot",
            cls._rollback_version_snapshot_task
        )
        engine.register_task(
            "version_creation.rollback_indexing",
            cls._rollback_indexing_task
        )
    
    @staticmethod
    def _detect_schema_changes_task(input_data: Dict[str, Any], instance: WorkflowInstance, step) -> Dict[str, Any]:
        """
            ...
            try:
                ...
                schema_changes = {
                    ...
                    "breaking_changes": [
                        ...
                        for c in schema_diff.changes if c.breaking
                    ],
                    "non_breaking_changes": [
                        ...
                        for c in schema_diff.changes if not c.breaking
                    ]
                }
    ...
    @staticmethod
    def _calculate_semantic_version_task(input_data: Dict[str, Any], instance: WorkflowInstance, step) -> Dict[str, Any]:
        """
    ...
    @staticmethod
    @transaction.atomic
    def _create_version_record_task(input_data: Dict[str, Any], instance: WorkflowInstance, step) -> Dict[str, Any]:
        """
    ...
    @staticmethod
    @transaction.atomic
    def _store_version_snapshot_task(input_data: Dict[str, Any], instance: WorkflowInstance, step) -> Dict[str, Any]:
        """
        Store version snapshot (optional).
    ...
    @staticmethod
    def _update_version_history_task(input_data: Dict[str, Any], instance: WorkflowInstance, step) -> Dict[str, Any]:
        """
    ...
    @staticmethod
    def _calculate_version_diff_task(input_data: Dict[str, Any], instance: WorkflowInstance, step) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            diff_summary = {
                ...
                "breaking_changes_count": sum(1 for c in comparison.schema_diff.changes if c.breaking),
                "non_breaking_changes_count": sum(1 for c in comparison.schema_diff.changes if not c.breaking)
            }
            
            if comparison.data_diff:
                diff_summary["row_count_diff"] = comparison.data_diff.row_count_diff
                diff_summary["row_count_percent_change"] = comparison.data_diff.row_count_percent_change
    ...
    @staticmethod
    def _update_lineage_references_task(input_data: Dict[str, Any], instance: WorkflowInstance, step) -> Dict[str, Any]:
        """
        ...
        return {
            "lineage_references_updated": True,
            "state": {
                "lineage_references_updated": True
            }
        }
    ...
    def _audit_logging_task(input_data: Dict[str, Any], instance: WorkflowInstance, step) -> Dict[str, Any]:
        ...
        audit_event = create_audit_event(
            ...
            details={
                ...
                "semantic_version": dataset.semantic_version,
                "version_hash": dataset.version_hash,
                "parent_version_id": str(dataset.parent_version.id) if dataset.parent_version else None,
                "asset_id": str(dataset.asset.id) if dataset.asset else None,
    ...
    @staticmethod
    @transaction.atomic
    def _rollback_version_record_task(input_data: Dict[str, Any], instance: WorkflowInstance, step) -> Dict[str, Any]:
    ...
    @staticmethod
    @transaction.atomic
    def _rollback_version_snapshot_task(input_data: Dict[str, Any], instance: WorkflowInstance, step) -> Dict[str, Any]:
