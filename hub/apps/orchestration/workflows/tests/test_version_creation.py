...
class VersionCreationWorkflowUnitTest(TestCase):
    ...
    def test_detect_schema_changes_task_with_parent(self):
        ...
        result = VersionCreationWorkflow._detect_schema_changes_task(input_data, instance, step)
    ...
    def test_detect_schema_changes_task_without_parent(self):
        ...
        input_data = {"tenant_id": str(self.tenant.id), "dataset_id": str(self.new_dataset.id)}
    ...
    def test_detect_schema_changes_task_missing_dataset(self):
        ...
        input_data = {"tenant_id": str(self.tenant.id), "dataset_id": str(uuid.uuid4())}
        ...
        with self.assertRaises(Dataset.DoesNotExist):
            VersionCreationWorkflow._detect_schema_changes_task(input_data, instance, step)
    ...
    def test_calculate_semantic_version_task_with_parent(self):
        ...
        instance.state_data = {"parent_version_id": str(self.parent_dataset.id)}
        instance.save()
    ...
    def test_create_version_record_task(self):
        ...
        result = VersionCreationWorkflow._create_version_record_task(input_data, instance, step)
    ...
    def test_store_version_snapshot_task_enabled(self):
        ...
        result = VersionCreationWorkflow._store_version_snapshot_task(input_data, instance, step)
    ...
    def test_update_version_history_task(self):
        ...
        result = VersionCreationWorkflow._update_version_history_task(input_data, instance, step)
    ...
    def test_calculate_version_diff_task(self):
        ...
        result = VersionCreationWorkflow._calculate_version_diff_task(input_data, instance, step)
    ...
    def test_update_lineage_references_task(self):
        ...
        result = VersionCreationWorkflow._update_lineage_references_task(input_data, instance, step)
    ...
    def test_index_for_search_task(self):
        ...
        result = VersionCreationWorkflow._index_for_search_task(input_data, instance, step)
    ...
    def test_send_notifications_task(self):
        ...
        result = VersionCreationWorkflow._send_notifications_task(input_data, instance, step)
    ...
    def test_audit_logging_task(self):
        ...
        result = VersionCreationWorkflow._audit_logging_task(input_data, instance, step)
    ...
    def test_rollback_version_record_task(self):
        ...
        instance.state_data = {"dataset_id": str(self.new_dataset.id)}
        instance.save()
        ...
        result = VersionCreationWorkflow._rollback_version_record_task(input_data, instance, step)
    ...
    def test_rollback_version_snapshot_task(self):
        ...
        snapshot = DatasetSnapshot.objects.create(
            dataset=self.new_dataset, snapshot_data={"test": "data"}, snapshot_type="FULL"
        )
        ...
        instance.state_data = {"snapshot_id": str(snapshot.id)}
        instance.save()
        ...
        result = VersionCreationWorkflow._rollback_version_snapshot_task(input_data, instance, step)

        self.assertTrue(result["rolled_back"])

        # Verify snapshot was deleted
        self.assertFalse(DatasetSnapshot.objects.filter(id=snapshot.id).exists())
    ...
    def test_rollback_indexing_task(self):
        ...
        instance.state_data = {"search_index_id": str(search_index.id)}
        instance.save()
        ...
        result = VersionCreationWorkflow._rollback_indexing_task(input_data, instance, step)
        ...
        self.assertFalse(SearchIndex.objects.filter(id=search_index.id).exists())
...
class VersionCreationWorkflowE2ETest(TestCase):
    ...
    def test_e2e_version_creation_journey(self):
        ...
        latest_dataset = (
            Dataset.objects.filter(tenant=self.tenant, asset=self.asset)
            .order_by("-version")
            .first()
        )
        ...
        self.assertEqual(
            new_dataset.semantic_version, "2.0.0"
        )  # Major increment for breaking change
        ...
        search_indices = SearchIndex.objects.filter(
            tenant=self.tenant, resource_type="DATASET", resource_id=new_dataset.id
        )
