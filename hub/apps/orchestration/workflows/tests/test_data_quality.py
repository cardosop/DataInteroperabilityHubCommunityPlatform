...
class DataQualityCheckWorkflowUnitTest(TestCase):
    ...
    def setUp(self):
        ...
        self.contract, _ = Contract.objects.get_or_create(
            tenant=self.tenant, defaults={"created_by": self.user}
        )
    ...
    def test_create_dq_run_task(self, mock_audit, mock_create_job, mock_storage, mock_dq_client):
        ...
        result = DataQualityCheckWorkflow._create_dq_run_task(input_data, instance, step)
    ...
    def test_execute_quality_rules_task(self, mock_storage_class, mock_dq_client_class):
        ...
        result = DataQualityCheckWorkflow._execute_quality_rules_task(input_data, instance, step)
    ...
    def test_calculate_quality_scores_task(self):
        ...
        result = DataQualityCheckWorkflow._calculate_quality_scores_task(input_data, instance, step)
    ...
    def test_detect_anomalies_task(self, mock_detector_class):
        ...
        result = DataQualityCheckWorkflow._detect_anomalies_task(input_data, instance, step)
    ...
    def test_generate_alerts_task(self, mock_alerting_class):
        ...
        result = DataQualityCheckWorkflow._generate_alerts_task(input_data, instance, step)
    ...
    def test_update_quality_metrics_task(self, mock_scorecard_class):
        ...
        result = DataQualityCheckWorkflow._update_quality_metrics_task(input_data, instance, step)
...
class DataQualityCheckWorkflowIntegrationTest(TestCase):
    ...
    def setUp(self):
        ...
        self.asset = Asset.objects.create(
            tenant=self.tenant, name="Test Asset", description="A test asset", created_by=self.user
        )
        ...
        self.contract = Contract.objects.create(
            tenant=self.tenant, created_by=self.user, status="ACTIVE"
        )
        self.contract.asset = self.asset
        self.contract.save()
    ...
    def test_full_workflow_execution_success(
        self, mock_audit, mock_scorecard, mock_alerting, mock_detector, mock_storage, mock_dq_client
    ):
    ...
    @patch("hub.apps.orchestration.workflows.data_quality.DQScorecardService")
    @patch("hub.apps.orchestration.workflows.data_quality.create_audit_event")
    def test_workflow_execution_with_dataset(
        self, mock_audit, mock_scorecard, mock_alerting, mock_detector, mock_storage, mock_dq_client
    ):
...
class DataQualityCheckWorkflowE2ETest(TestCase):
    ...
    @patch("hub.apps.orchestration.workflows.data_quality.DQScorecardService")
    @patch("hub.apps.orchestration.workflows.data_quality.create_audit_event")
    def test_dq_run_creation_via_workflow(
        self, mock_audit, mock_scorecard, mock_alerting, mock_detector, mock_storage, mock_dq_client
    ):
        """
