...
class AccessRequestWorkflowUnitTest(TestCase):
    ...
    def setUp(self):
        ...
        UserRole.objects.get_or_create(user=self.approver, role=self.tenant_admin_role)
        ...
        self.file, _ = File.objects.get_or_create(
            ...
            defaults={"content_type": "text/csv", "size": 1024, "status": "ACTIVE"},
        )
    ...
    def test_create_access_request_task_success(self, mock_audit, mock_email):
        ...
        result = AccessRequestWorkflow._create_access_request_task(input_data, instance, step)
    ...
    def test_classify_request_task_with_classification(self, mock_audit, mock_email):
        ...
        result = AccessRequestWorkflow._classify_request_task(input_data, instance, step)
    ...
    def test_route_to_approvers_task_single_step(self, mock_audit, mock_email):
        ...
        result = AccessRequestWorkflow._route_to_approvers_task(input_data, instance, step)
    ...
    def test_wait_for_step_approval_task_approved(self, mock_audit, mock_email):
        ...
        result = AccessRequestWorkflow._wait_for_step_approval_task(input_data, instance, step)
    ...
    def test_wait_for_step_approval_task_timeout(self, mock_audit, mock_email):
        ...
        instance.state_data["access_request_id"] = str(access_request.id)
        instance.state_data["loop_item"] = {"step": 0, "timeout_hours": 48, "escalation_hours": 24}
        instance.save()
    ...
    def test_escalate_approval_task(self, mock_audit, mock_email):
        ...
        result = AccessRequestWorkflow._escalate_approval_task(input_data, instance, step)
        ...
        workflow_step = (
            access_request.approval_workflow[0] if access_request.approval_workflow else {}
        )
        ...
        self.assertTrue(
            escalated
            or any(
                esc_id in workflow_step.get("approvers", [])
                for esc_id in result["escalation_approvers"]
            )
        )
    ...
    def test_grant_access_task(self, mock_audit, mock_email):
        ...
        result = AccessRequestWorkflow._grant_access_task(input_data, instance, step)
    ...
    def test_send_notifications_task(self, mock_audit, mock_email):
        ...
        result = AccessRequestWorkflow._send_notifications_task(input_data, instance, step)
    ...
    def test_audit_logging_task(self, mock_audit, mock_email):
        ...
        result = AccessRequestWorkflow._audit_logging_task(input_data, instance, step)
    ...
    def test_approve_access_request_method(self, mock_audit, mock_email):
        ...
        approved = AccessRequestWorkflow.approve_access_request(
            access_request_id=str(access_request.id), approved_by_id=str(self.approver.id)
        )
    ...
    def test_access_request_workflow_execute_success(self, mock_audit, mock_email):
        ...
        self.assertEqual(
            ...
            f"PUBLIC auto-approve path must set status=APPROVED, got {access_request.status!r}",
        )
        self.assertIsNotNone(
