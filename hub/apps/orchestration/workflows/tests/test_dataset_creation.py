...
class DatasetCreationWorkflowUnitTest(TestCase):
    ...
    def test_validate_file_format_task(self):
        ...
        result = DatasetCreationWorkflow._validate_file_format_task(input_data, instance, step)
    ...
    def test_validate_file_format_task_invalid_file(self):
        ...
        with self.assertRaises(ValueError) as cm:
            DatasetCreationWorkflow._validate_file_format_task(input_data, instance, step)
    ...
    def test_upload_file_to_storage_task_already_uploaded(self, mock_storage_class):
        ...
        result = DatasetCreationWorkflow._upload_file_to_storage_task(input_data, instance, step)
    ...
    def test_infer_schema_task_csv(self, mock_storage_class):
        ...
        mock_storage_client = MagicMock()
        mock_storage_client.get_file_content.return_value = (
            b"id,name,value\n1,test1,value1\n2,test2,value2\n"
        )
        mock_storage_class.return_value = mock_storage_client
        ...
        result = DatasetCreationWorkflow._infer_schema_task(input_data, instance, step)
    ...
    def test_extract_sample_data_task(self, mock_storage_class):
        ...
        result = DatasetCreationWorkflow._extract_sample_data_task(input_data, instance, step)
    ...
    def test_create_dataset_record_task(self):
        ...
        sample_data_json = [{"id": 1, "name": "test1"}, {"id": 2, "name": "test2"}]
        ...
        result = DatasetCreationWorkflow._create_dataset_record_task(input_data, instance, step)
    ...
    def test_create_dataset_record_task_with_asset(self):
        ...
        schema_json = {"fields": [{"name": "id", "type": "integer"}], "row_count_estimated": 50}
    ...
    def test_link_dataset_to_asset_task(self):
        ...
        instance.state_data = {"dataset_id": str(dataset.id), "asset_id": str(asset.id)}
        instance.save()
        ...
        result = DatasetCreationWorkflow._link_dataset_to_asset_task(input_data, instance, step)
    ...
    def test_index_for_search_task(self):
        ...
        result = DatasetCreationWorkflow._index_for_search_task(input_data, instance, step)
    ...
    def test_send_notifications_task(self):
        ...
        instance.state_data = {"dataset_id": str(dataset.id), "triggered_by_id": str(self.user.id)}
        instance.save()
        ...
        result = DatasetCreationWorkflow._send_notifications_task(input_data, instance, step)
    ...
    def test_audit_logging_task(self, mock_create_audit):
        ...
        result = DatasetCreationWorkflow._audit_logging_task(input_data, instance, step)
    ...
    def test_rollback_dataset_record_task(self):
        ...
        instance.state_data = {"dataset_id": dataset_id}
        instance.save()
        ...
        result = DatasetCreationWorkflow._rollback_dataset_record_task(input_data, instance, step)
        ...
        try:
            ...
            if (
                ...
                or "TransactionManagementError" in error_type
            ):
...
class DatasetCreationWorkflowE2ETest(TestCase):
    ...
    def test_e2e_dataset_creation_journey(self, mock_storage_class):
        ...
        search_indices = SearchIndex.objects.filter(
            tenant=self.tenant, resource_type="DATASET", resource_id=dataset.id
        )
        ...
        audit_events = AuditEvent.objects.filter(
            tenant=self.tenant, resource_type="DATASET", resource_id=str(dataset.id)
        )
