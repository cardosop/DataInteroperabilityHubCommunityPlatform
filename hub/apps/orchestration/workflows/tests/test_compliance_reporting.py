...
class ComplianceReportingWorkflowUnitTest(TestCase):
    ...
    def test_trigger_report_generation_task_invalid_regulation(self):
        ...
        with self.assertRaises(ValueError) as cm:
            ComplianceReportingWorkflow._trigger_report_generation_task(input_data, instance, step)
    ...
    def test_trigger_report_generation_task_missing_tenant_id(self):
        ...
        input_data = {"regulation": "GDPR"}

        instance = self.engine.create_instance(
            workflow_name=ComplianceReportingWorkflow.WORKFLOW_NAME, input_data=input_data
        )
    ...
    def test_generate_report_task_gdpr(self):
        ...
        instance = self.engine.create_instance(
            workflow_name=ComplianceReportingWorkflow.WORKFLOW_NAME,
            input_data={"tenant_id": str(self.tenant.id), "regulation": "GDPR"},
            tenant_id=str(self.tenant.id),
        )
        instance.state_data = {
            "tenant_id": str(self.tenant.id),
        ...
        result = ComplianceReportingWorkflow._generate_report_task(input_data, instance, step)
    ...
    def test_generate_report_task_hipaa(self):
        ...
        instance = self.engine.create_instance(
            workflow_name=ComplianceReportingWorkflow.WORKFLOW_NAME,
            input_data={"tenant_id": str(self.tenant.id), "regulation": "HIPAA"},
            tenant_id=str(self.tenant.id),
        )
        instance.state_data = {
            "tenant_id": str(self.tenant.id),
    ...
    def test_validate_report_task_valid(self):
        ...
        report_data = {
            ...
            "compliance_runs": {"total": 10, "passed": 8, "failed": 2},
            "pii_detection": {"total_classifications": 5},
            "data_subject_rights": {"access_requests": 3},
        ...
        result = ComplianceReportingWorkflow._validate_report_task(input_data, instance, step)
    ...
    def test_validate_report_task_invalid_missing_fields(self):
        ...
        with self.assertRaises(ValueError) as cm:
            ComplianceReportingWorkflow._validate_report_task(input_data, instance, step)
    ...
    def test_send_report_task_with_recipients(self, mock_send_email):
        ...
        result = ComplianceReportingWorkflow._send_report_task(input_data, instance, step)
    ...
    def test_store_report_task(self):
        ...
        result = ComplianceReportingWorkflow._store_report_task(input_data, instance, step)
    ...
    def test_audit_logging_task(self, mock_create_audit):
        ...
        result = ComplianceReportingWorkflow._audit_logging_task(input_data, instance, step)
    ...
    def test_execute_workflow_invalid_regulation(self):
        ...
        with self.assertRaises(ValueError) as cm:
            ComplianceReportingWorkflow.execute(
                tenant_id=str(self.tenant.id), regulation="INVALID", report_type="STANDARD"
            )
        self.assertIn("Invalid regulation", str(cm.exception))
...
class ComplianceReportingWorkflowE2ETest(TestCase):
    ...
    def test_e2e_gdpr_reporting_journey(self):
        ...
        audit_events = AuditEvent.objects.filter(
            tenant=self.tenant, resource_type="COMPLIANCE_REPORT", resource_id=str(report.id)
        )
