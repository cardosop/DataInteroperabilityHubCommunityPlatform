...
class DataMeshWorkflowUnitTest(TestCase):
    ...
    def test_validate_domain_task(self):
        ...
        result = DataMeshWorkflow._validate_domain_task(input_data, instance, step)
    ...
    def test_validate_domain_task_missing_name(self):
        ...
        with self.assertRaises(ValueError) as context:
            DataMeshWorkflow._validate_domain_task(input_data, instance, step)
    ...
    def test_allocate_resources_task(self, mock_validate_quota):
        ...
        instance.state_data = {"validated_resource_quota": {"storage_gb": 100, "compute_hours": 50}}
        instance.save()
        ...
        result = DataMeshWorkflow._allocate_resources_task(input_data, instance, step)
    ...
    def test_allocate_resources_task_validation_fails(self, mock_validate_quota):
        ...
        input_data = {"tenant_id": str(self.tenant.id), "resource_quota": {"storage_gb": 10000}}
        instance = self.engine.create_instance(
            workflow_name=DataMeshWorkflow.WORKFLOW_NAME,
            input_data=input_data,
            tenant_id=str(self.tenant.id),
        ...
        instance.state_data = {"validated_resource_quota": {"storage_gb": 10000}}
        instance.save()
        ...
        with self.assertRaises(ValueError) as context:
            DataMeshWorkflow._allocate_resources_task(input_data, instance, step)
    ...
    def test_create_domain_task(self, mock_update_progress):
        ...
        result = DataMeshWorkflow._create_domain_task(input_data, instance, step)
    ...
    def test_apply_default_policies_task(self, mock_apply_policy):
        ...
        result = DataMeshWorkflow._apply_default_policies_task(input_data, instance, step)
    ...
    def test_initialize_analytics_task(self):
        ...
        result = DataMeshWorkflow._initialize_analytics_task(input_data, instance, step)
    ...
    def test_complete_task(self, mock_event_publisher_class):
        ...
        instance.state_data = {"domain_id": str(domain.id), "applied_policies": []}
        instance.save()
        ...
        result = DataMeshWorkflow._complete_task(input_data, instance, step)
    ...
    def test_rollback_domain_creation_task(self):
        ...
        result = DataMeshWorkflow._rollback_domain_creation_task(input_data, instance, step)
    ...
    def test_rollback_policy_application_task(self):
        ...
        instance.state_data = {
            ...
            "applied_policies": [
                {"policy_id": str(policy.id), "application_id": str(policy_application.id)}
            ],
        }
        instance.save()
        ...
        result = DataMeshWorkflow._rollback_policy_application_task(input_data, instance, step)
