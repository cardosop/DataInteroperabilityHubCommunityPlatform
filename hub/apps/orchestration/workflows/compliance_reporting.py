...
from hub.apps.governance.models import DataClassification, AccessRequest
...
class ComplianceReportingWorkflow:
        ...
        workflow_dsl = {
            ...
            "steps": [
                ...
                },
                {
                    "name": "send_report",
                    "type": "task",
                    "task": "compliance_reporting.send_report"
                },
                {
                    "name": "store_report",
                    "type": "task",
    ...
    def register_tasks(cls, engine: WorkflowEngine) -> None:
        ...
        engine.register_task(
            "compliance_reporting.trigger_report_generation",
            cls._trigger_report_generation_task
        )
        engine.register_task(
            "compliance_reporting.collect_compliance_data",
            cls._collect_compliance_data_task
        )
        engine.register_task(
            "compliance_reporting.generate_report",
            cls._generate_report_task
        )
        engine.register_task(
            "compliance_reporting.validate_report",
            cls._validate_report_task
        )
        engine.register_task(
            "compliance_reporting.send_report",
            cls._send_report_task
        )
        engine.register_task(
            "compliance_reporting.store_report",
            cls._store_report_task
        )
        engine.register_task(
            "compliance_reporting.audit_logging",
            cls._audit_logging_task
        )
    
    @staticmethod
    def _trigger_report_generation_task(input_data: Dict[str, Any], instance: WorkflowInstance, step) -> Dict[str, Any]:
        """
        Trigger report generation (scheduled/manual).
        ...
        if regulation not in ["GDPR", "HIPAA", "SOX", "LGPD", "CCPA"]:
            raise ValueError(f"Invalid regulation: {regulation}. Must be one of: GDPR, HIPAA, SOX, LGPD, CCPA")
    ...
    @staticmethod
    def _collect_compliance_data_task(input_data: Dict[str, Any], instance: WorkflowInstance, step) -> Dict[str, Any]:
        """
        Collect compliance data (classifications, access logs, etc.).
    ...
    @staticmethod
    def _generate_report_task(input_data: Dict[str, Any], instance: WorkflowInstance, step) -> Dict[str, Any]:
        """
        Generate report (GDPR/HIPAA/SOX/etc.).
    ...
    @staticmethod
    def _validate_report_task(input_data: Dict[str, Any], instance: WorkflowInstance, step) -> Dict[str, Any]:
        """
        Validate report completeness.
    ...
    @staticmethod
    def _send_report_task(input_data: Dict[str, Any], instance: WorkflowInstance, step) -> Dict[str, Any]:
        """
        Send report (email/API).
    ...
    @staticmethod
    @transaction.atomic
    def _store_report_task(input_data: Dict[str, Any], instance: WorkflowInstance, step) -> Dict[str, Any]:
        """
        Store report for audit.
