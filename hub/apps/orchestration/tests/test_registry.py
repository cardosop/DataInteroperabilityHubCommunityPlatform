...
class WorkflowRegistryTest(TestCase):
    ...
    def test_register_workflow(self):
        ...
        workflow_def = self.registry.register_workflow(
            workflow_name="test_workflow", dsl_json=self.valid_dsl
        )
    ...
    def test_register_workflow_invalid_dsl(self):
        ...
        with self.assertRaises(ValidationError):
            self.registry.register_workflow(workflow_name="test_workflow", dsl_json=invalid_dsl)

    def test_discover_workflows_by_name(self):
        """Test discovering workflows by name"""
        self.registry.register_workflow(workflow_name="test_workflow", dsl_json=self.valid_dsl)
        self.registry.register_workflow(workflow_name="other_workflow", dsl_json=self.valid_dsl)
    ...
    def test_discover_workflows_active(self):
        ...
        WorkflowDefinition.objects.create(
            name="test_workflow", version="1.0.1", dsl_json=self.valid_dsl, is_active=False
        )
    ...
    def test_get_dependencies(self):
        ...
        self.registry.register_workflow(
            workflow_name="dependency_workflow", dsl_json=self.valid_dsl
        )
        ...
        self.registry.register_workflow(workflow_name="test_workflow", dsl_json=dsl_with_dep)
    ...
    def test_get_dependents(self):
        ...
        self.registry.register_workflow(workflow_name="base_workflow", dsl_json=self.valid_dsl)
        ...
        self.registry.register_workflow(workflow_name="dependent_workflow", dsl_json=dsl_with_dep)
