...
class WorkflowVersionManagerTest(TestCase):
    ...
    def test_get_workflow_definition_active(self):
        ...
        workflow_def = WorkflowVersionManager.get_workflow_definition("test_workflow")
    ...
    def test_get_all_versions(self):
        ...
        versions = WorkflowVersionManager.get_all_versions("test_workflow")
    ...
    def test_activate_version(self):
        ...
        workflow_def_2 = WorkflowDefinition.objects.create(
            name="test_workflow",
            version="1.0.1",
            dsl_json=self.valid_dsl,
            is_active=False
        ...
        activated = WorkflowVersionManager.activate_version("test_workflow", "1.0.1")
        
        self.assertTrue(activated.is_active)
        
        # Check that other version is deactivated
        workflow_def_1 = WorkflowDefinition.objects.get(
            name="test_workflow",
            version="1.0.0"
        )
