# Generated manually for deprecated contract specification removal (Phase 0.2)
# Date: 2025-01-15
...
def reverse_migration(apps, schema_editor):
    """
    Reverse migration: Cannot fully reverse as we don't know which contracts were originally deprecated format.
