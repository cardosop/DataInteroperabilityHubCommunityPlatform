...
def load_odps_schema(version: str) -> Dict[str, Any]:
    """
    Load ODPS JSON Schema for given version.

    This function loads the JSON Schema file for the specified ODPS version
    from the schemas directory. It handles version normalization and provides
    clear error messages for missing or invalid schema files.
    ...
    if not schema_path.exists():
        raise FileNotFoundError(
            f"ODPS schema not found for version '{version}' (normalized: '{version_dir}'). "
