...
class APIFilteringPhase15TestCase(ContractsAPITestBase):
    ...
    def test_filter_by_server_type_multiple_matches(self):
        ...
        contract4 = self._create_contract(
            name="Contract 4",
            servers=[{"type": "s3", "url": "s3://bucket2"}]
        )
    ...
    def test_filter_no_results(self):
        ...
        response = self.client.get('/api/v1/contracts/', {'contact_email': 'nonexistent@example.com'})
