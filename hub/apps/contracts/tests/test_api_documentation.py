...
class APIDocumentationReviewTest(TestCase):
    ...
    def setUp(self):
        ...
        self.docs_file = (
            Path(__file__).parent.parent.parent.parent.parent / "docs" / "API_REFERENCE.md"
        )
    ...
    def test_odps_endpoints_documented(self):
        ...
        self.assertIn(
            "resolve_external_refs", content, "resolve_external_refs field should be documented"
        )
    ...
    def test_export_endpoints_documented(self):
        ...
        self.assertIn(
            "## Export Endpoints", content, "Export endpoints section should be documented"
        )
    ...
    def test_linking_endpoints_documented(self):
        ...
        self.assertIn(
            "## Linking Endpoints", content, "Linking endpoints section should be documented"
        )
    ...
    def test_query_parameters_documented(self):
        ...
        self.assertIn(
            "output_format", content, "output_format query parameter should be documented"
        )
    ...
    def test_authentication_requirements_documented(self):
        ...
        self.assertIn(
            "Authorization: Bearer", content, "Authentication should be shown in examples"
        )
    ...
    def test_content_type_documented(self):
        ...
        self.assertIn(
            "Content-Type: application/json", content, "Content-Type should be shown in examples"
        )
    ...
    def test_documentation_structure_is_valid(self):
        ...
        self.assertEqual(code_block_count % 2, 0, "Code blocks should be properly closed")
    ...
    def test_examples_are_complete(self):
        ...
        self.assertGreater(len(curl_examples), 0, "Documentation should have curl examples")

        # Check that examples include URLs
        self.assertIn("https://api.example.com", content, "Examples should include API URLs")
    ...
    def test_format_options_are_clear(self):
        ...
        if "format" in content:
            ...
            self.assertTrue(
                "odps" in content or "ODPS" in content, "ODPS format option should be documented"
            )
            self.assertTrue(
                "odcs" in content or "ODCS" in content, "ODCS format option should be documented"
            )
