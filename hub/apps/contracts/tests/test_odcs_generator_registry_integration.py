...
class ODCSGeneratorRegistryIntegrationTest(TestCase):
    ...
    def test_end_to_end_generation_with_explicit_version(self):
        ...
        hub_contract = {
            ...
            "info": {
                "name": "Integration Test Contract 2",
                "version": "1.0.0"
            },
            "schema": {
            ...
            "original_spec": {
                "type": "ODCS",
                "version": "3.0.0"  # Original version
            }
        }
    ...
    def test_end_to_end_generation_with_fallback(self):
        ...
        hub_contract = {
            ...
            "info": {
                "name": "Integration Test Contract 3",
                "version": "1.0.0"
            },
            "schema": {
                "fields": [{"name": "id", "type": "string"}]
    ...
    def test_version_detection_priority(self):
        ...
        hub_contract = {
            ...
            "original_spec": {
                "type": "ODCS",
                "version": "3.0.0"  # Metadata says 3.0.0
            }
        }
