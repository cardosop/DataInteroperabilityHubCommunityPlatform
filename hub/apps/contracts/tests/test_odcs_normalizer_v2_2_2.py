...
class ODCSNormalizerV2_2_2SupportsTest(TestCase):
    ...
    def test_supports_version_2_2_2(self):
        """Test that _supports_version returns True for version 2.2.2."""
        normalizer = ODCSNormalizerV2_2_2()
        assert normalizer._supports_version("2.2.2") is True
    ...
    def test_does_not_support_other_versions(self):
        ...
        assert normalizer._supports_version("2.2.1") is False
        assert normalizer._supports_version("2.2.3") is False
        assert normalizer._supports_version("2.3.0") is False
