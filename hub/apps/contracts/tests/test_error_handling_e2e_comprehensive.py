...
class ErrorHandlingE2EComprehensiveTest(TestCase):
    """
    ...
    def setUp(self):
        ...
        self.tenant = Tenant.objects.create(
            name=f"Test Tenant Error {unique_id}",
            slug=f"test-tenant-error-{unique_id}",
        ...
        self.user = User.objects.create_user(
            email=f"test-error-{unique_id}@example.com",
    ...
    def test_invalid_odps_malformed_json(self):
        ...
        # Test malformed JSON
        malformed_json = '{"schema": "https://opendataproducts.org/schema/v4.1", "product": {invalid}'
    ...
    def test_missing_required_field_product_contract_spec(self):
        ...
        odps_no_spec = {
            ...
            "product": {
                "details": {
                    "en": {
                        "productID": "test-product-no-spec",
                        "name": "Test Product"
                    }
                },
                "contract": {}
    ...
    def test_ref_resolution_failure_internal_ref_not_found(self):
        ...
        odps_bad_internal_ref = {
            ...
            "product": {
                "details": {
                    "en": {
                        "productID": "test-product-bad-ref",
                        "name": "Test Product"
                    }
                },
                "contract": {
    ...
    def test_ref_resolution_failure_local_ref_not_found(self):
        ...
        odps_bad_local_ref = {
            ...
            "product": {
                "details": {
                    "en": {
                        "productID": "test-product-bad-local-ref",
                        "name": "Test Product"
                    }
                },
                "contract": {
                    "$ref": "./nonexistent-contract.json"
                }
            }
        }
    ...
    def test_ref_resolution_failure_external_ref_timeout(self):
        ...
        odps_bad_external_ref = {
            ...
            "product": {
                "details": {
                    "en": {
                        "productID": "test-product-bad-external-ref",
                        "name": "Test Product"
                    }
                },
                "contract": {
                    "$ref": "https://nonexistent-domain-12345.example.com/contract.json"
                }
            }
        }
    ...
    def test_ref_resolution_failure_circular_reference(self):
        ...
        odps_circular_ref = {
            ...
            "definitions": {
                "contract": {
                    "$ref": "#/definitions/contract"  # Circular reference
                }
            },
            "product": {
                "details": {
                    "en": {
                        "productID": "test-product-circular-ref",
                        "name": "Test Product"
                    }
                },
                "contract": {
    ...
    def test_contract_extraction_failure_missing_contract(self):
        ...
        odps_no_contract = {
            ...
            "product": {
                "details": {
                    "en": {
                        "productID": "test-product-extraction-fail",
                        "name": "Test Product"
                    }
                }
    ...
    def test_contract_extraction_failure_invalid_contract_spec(self):
        ...
        odps_invalid_spec = {
            ...
            "product": {
                "details": {
                    "en": {
                        "productID": "test-product-invalid-spec",
                        "name": "Test Product"
                    }
                },
                "contract": {
                    "spec": "this should be a dict, not a string"
                }
            }
        }
    ...
    def test_contract_extraction_failure_invalid_odcs_contract(self):
        ...
        odps_invalid_odcs = {
            ...
            "product": {
                "details": {
                    "en": {
                        "productID": "test-product-invalid-odcs",
                        "name": "Test Product"
                    }
                },
                "contract": {
    ...
    def test_contract_extraction_failure_ref_resolution_fails(self):
        ...
        odps_bad_contract_ref = {
            ...
            "product": {
                "details": {
                    "en": {
                        "productID": "test-product-bad-contract-ref",
                        "name": "Test Product"
                    }
                },
                "contract": {
                    "$ref": "#/definitions/nonexistent_contract"
                }
            }
        }
    ...
    def test_linking_validation_failure_wrong_spec_type(self):
        ...
        if (odcs_response_1.status_code == status.HTTP_201_CREATED and
            odcs_response_2.status_code == status.HTTP_201_CREATED):
