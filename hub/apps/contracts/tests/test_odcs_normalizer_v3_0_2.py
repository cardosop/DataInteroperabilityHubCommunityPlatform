...
class ODCSNormalizerV3_0_2SupportsTest(TestCase):
    ...
    def test_supports_version_3_0_2(self):
        """Test that _supports_version returns True for version 3.0.2."""
        normalizer = ODCSNormalizerV3_0_2()
        assert normalizer._supports_version("3.0.2") is True
    ...
    def test_supports_version_3_0_2_with_patch(self):
        """Test that _supports_version returns True for version 3.0.2.x."""
        normalizer = ODCSNormalizerV3_0_2()
        # Should support versions starting with 3.0.2
        assert normalizer._supports_version("3.0.2.1") is True
        assert normalizer._supports_version("3.0.2.5") is True
