...
class ODCSNormalizerV3_0_2SupportsTest(TestCase):
    ...
    def test_supports_version_3_0_2(self):
        ...
        self.assertTrue(normalizer.supports(OriginalSpecType.ODCS, "3.0.2", contract_data) is True)
    ...
    def test_supports_version_3_0_2_with_patch(self):
        ...
        # Test through public API - supports() internally calls _supports_version()
        self.assertTrue(( normalizer.supports( OriginalSpecType.ODCS, "3.0.2.1", {"apiVersion": "odcs.io/v3.0.2.1"} ) is True ))
        self.assertTrue(( normalizer.supports( OriginalSpecType.ODCS, "3.0.2.5", {"apiVersion": "odcs.io/v3.0.2.5"} ) is True ))

    def test_does_not_support_other_versions(self):
        """Test that supports() returns False for other versions through public API."""
        normalizer = ODCSNormalizerV3_0_2()
        # Test through public API - supports() internally calls _supports_version()
        self.assertTrue(( normalizer.supports(OriginalSpecType.ODCS, "3.0.1", {"apiVersion": "odcs.io/v3.0.1"}) is False ))
        self.assertTrue(( normalizer.supports(OriginalSpecType.ODCS, "3.0.0", {"apiVersion": "odcs.io/v3.0.0"}) is False ))
        self.assertTrue(( normalizer.supports(OriginalSpecType.ODCS, "3.1.0", {"apiVersion": "odcs.io/v3.1.0"}) is False ))
        self.assertTrue(( normalizer.supports(OriginalSpecType.ODCS, "4.0.0", {"apiVersion": "odcs.io/v4.0.0"}) is False ))

    def test_supports_odcs_spec_type(self):
        """Test that supports() returns True for ODCS spec type with version 3.0.2."""
        normalizer = ODCSNormalizerV3_0_2()
        self.assertTrue(normalizer.supports(OriginalSpecType.ODCS, "3.0.2", {}) is True)
...
class ODCSNormalizerV3_0_2RegistryTest(TestCase):
    ...
    def test_normalizer_can_be_registered(self):
        ...
        self.assertIsInstance(retrieved, ODCSNormalizerV3_0_2)
...
class ODCSNormalizerV3_0_2RegressionTest(TestCase):
    ...
    def test_normalization_calculates_coverage(self):
        ...
        self.assertEqual(result.hub_contract["normalization"]["original_spec_type"] , OriginalSpecType.ODCS)
        self.assertIn("original_spec_version", result.hub_contract["normalization"])
        self.assertEqual(result.hub_contract["normalization"]["original_spec_version"] , "3.0.2")
...
class ODCSNormalizerV3_0_2EdgeCaseTest(ODCSEdgeCaseMixin, TestCase):
    """Standard edge-case tests for ODCS 3.0.2 normalizer (via shared mixin)."""

    normalizer_class = ODCSNormalizerV3_0_2
    spec_version = "3.0.2"
...
class ODCSNormalizerV3_0_2VersionRoutingTest(TestCase):
    """Verify version-routing behavior — ODCS 3.0.2 is a version-specific normalizer
    ...
    def test_version_routing_via_registry(self):
        """Registry returns ODCSNormalizerV3_0_2 for version 3.0.2 contracts."""
        contract_data = {
            "apiVersion": "odcs.io/v3.0.2",
            "kind": "DataContract",
            "id": "test",
    ...
    def test_map_version_specific_fields_with_correct_version(self):
        ...
        # Should complete without modifying hub_contract structure unexpectedly
        self.assertEqual(hub_contract["id"], "test")
        self.assertEqual(hub_contract["info"]["name"], "Test")

    def test_map_version_specific_fields_warns_on_version_mismatch(self):
        """_map_version_specific_fields logs a warning for unexpected version."""
        normalizer = ODCSNormalizerV3_0_2()
        odcs_contract = {"id": "test", "name": "Test"}
        hub_contract = {"id": "test"}
        warnings = []
        normalizer._map_version_specific_fields(odcs_contract, hub_contract, warnings, "3.0.1")
        # Should still complete without raising — version mismatch is non-fatal here
        self.assertEqual(hub_contract["id"], "test")

    def test_normalize_routes_version_3_0_2_correctly(self):
        """Full normalization pipeline routes 3.0.2 contracts correctly."""
        normalizer = ODCSNormalizerV3_0_2()
        contract_data = {
            "apiVersion": "odcs.io/v3.0.2",
            "kind": "DataContract",
