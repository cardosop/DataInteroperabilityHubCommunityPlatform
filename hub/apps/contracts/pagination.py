...
def paginate_queryset(
    queryset: QuerySet, page: int = 1, page_size: int = 50, max_page_size: int = 100
...
def optimize_queryset_for_pagination(queryset: QuerySet, ordering: str | None = None) -> QuerySet:
    """
...
def get_pagination_params(request) -> dict[str, Any]:
    ...
    return {"page": page, "page_size": page_size, "max_page_size": max_page_size}
