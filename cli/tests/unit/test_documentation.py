...
class TestCLIDocumentation:
    ...
    def test_readme_contains_odps_section(self, readme_path):
        ...
        assert "ODPS" in content or "odps" in content.lower(), (
            "README should contain ODPS documentation"
        )
        ...
        assert "get-access-methods" in content.lower(), (
            "README should document get-access-methods command"
        )
    ...
    def test_readme_contains_odps_examples(self, readme_path):
        ...
        assert "--extract-odcs" in content or "--link-odcs" in content, (
            "README should contain ODPS linking examples"
        )

    def test_readme_contains_odps_workflow(self, readme_path):
        """Test that README contains ODPS workflow examples"""
        content = readme_path.read_text()
        assert "ODPS Workflow" in content or "ODPS workflow" in content, (
            "README should contain ODPS workflow section"
        )
    ...
    def test_odps_usage_doc_structure(self, odps_usage_path):
        ...
        assert "Creating ODPS" in content or "create-odps" in content.lower(), (
            "ODPS doc should cover creation"
        )
        assert "Information" in content or "get-pricing" in content.lower(), (
            "ODPS doc should cover information commands"
        )
        assert "Workflow" in content or "workflow" in content.lower(), (
            "ODPS doc should cover workflows"
        )
    ...
    def test_odps_usage_doc_contains_troubleshooting(self, odps_usage_path):
        ...
        assert "Troubleshooting" in content or "troubleshooting" in content.lower(), (
            "ODPS doc should have troubleshooting section"
        )
    ...
    def test_readme_odps_command_reference(self, readme_path):
        ...
        assert "Command Reference" in content or "| Command |" in content, (
            "README should contain command reference"
        )
    ...
    def test_documentation_accuracy(self, readme_path):
        ...
        assert "odps" in content.lower() or "ODPS" in content, (
            "README should document ODPS commands"
        )
    ...
    def test_readme_contains_baas_section(self, readme_path):
        ...
        content = readme_path.read_text()
        assert "BaaS" in content or "baas" in content.lower(), (
            "README should contain BaaS documentation"
        )
        ...
        assert "docs" in content.lower() or "documentation" in content.lower(), (
            "README should document docs commands"
        )
    ...
    def test_readme_contains_baas_examples(self, readme_path):
        ...
        content = readme_path.read_text()
        assert "baas api-keys create" in content.lower(), (
            "README should contain api-keys create example"
        )
        assert "baas docs show" in content.lower() or "baas docs openapi" in content.lower(), (
            "README should contain docs examples"
        )
    ...
    def test_readme_contains_baas_workflow(self, readme_path):
        ...
        assert "api-keys" in content.lower() and (
            "create" in content.lower() or "list" in content.lower()
        ), "README should contain BaaS API key examples"
    ...
    def test_baas_usage_doc_structure(self, baas_usage_path):
        ...
        assert "API Key" in content or "api-keys" in content.lower(), (
            "BaaS doc should cover API key management"
        )
        assert "Usage Tracking" in content or "usage" in content.lower(), (
            "BaaS doc should cover usage tracking"
        )
        assert "Developer Portal" in content or "docs" in content.lower(), (
            "BaaS doc should cover developer portal"
        )
        assert "Workflow" in content or "workflow" in content.lower(), (
            "BaaS doc should cover workflows"
        )
    ...
    def test_baas_usage_doc_contains_troubleshooting(self, baas_usage_path):
        ...
        content = baas_usage_path.read_text()
        assert "Troubleshooting" in content or "troubleshooting" in content.lower(), (
            "BaaS doc should have troubleshooting section"
        )
    ...
    def test_baas_usage_doc_contains_error_handling(self, baas_usage_path):
        ...
        assert "Error Handling" in content or "error handling" in content.lower(), (
            "BaaS doc should have error handling section"
        )
    ...
    def test_readme_baas_command_reference(self, readme_path):
        ...
        assert (
            "api-keys" in content.lower() or "docs" in content.lower() or "usage" in content.lower()
        ), "README should contain BaaS command examples"

    def test_readme_baas_usage_guide_link(self, readme_path):
        """Test that README links to BaaS usage guide"""
        content = readme_path.read_text()
        assert "BAAS_USAGE.md" in content or "BaaS Usage Guide" in content, (
            "README should link to BaaS usage guide"
        )
