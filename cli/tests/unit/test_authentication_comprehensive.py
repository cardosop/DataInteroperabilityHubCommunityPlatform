...
class TestAPIKeyAuthentication:
    ...
    def test_get_auth_headers_with_both_auth_methods_uses_access_token(self, test_config, test_auth):
...
class TestTokenRefresh:
    ...
    @patch('datahub_cli.auth.requests.post')
    def test_refresh_access_token_clears_jwt_preserves_api_key(self, mock_post, test_config, test_auth):
