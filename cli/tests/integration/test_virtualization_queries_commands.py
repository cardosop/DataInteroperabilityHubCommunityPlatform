...
for verify_attempt in range(max_verify_attempts):
    ...
    if verify_key:
        break
    time.sleep(0.2 * (verify_attempt + 1))  # noqa: sleep-needed — test timing requirement
            ...
            if not api_key:
                ...
                for potential_key in matches:
                    if (
                        ...
                        and not potential_key.startswith("virtualization-queries-cli-test")
...
class TestVirtualizationQueriesCommandsRealAPI:
    ...
    def test_queries_list_command(self, setup_config, api_available):
        ...
        result = runner.invoke(
            cli, ["virtualization", "queries", "list", "--format", "json", "--page-size", "10"]
        )
    ...
    def test_queries_list_with_filters(self, setup_config, api_available, test_dataset_id):
        ...
        result = runner.invoke(
            cli, ["virtualization", "queries", "list", "--status", "COMPLETED", "--format", "json"]
        )
    ...
    def test_queries_execute_and_get_command(self, setup_config, api_available, test_dataset_id):
        ...
        if result.exit_code == 0:
            ...
            # Get execution
            result = runner.invoke(
                cli, ["virtualization", "queries", "get", execution_id, "--format", "json"]
            )
            ...
            assert (
                "sources" in result.output.lower()
    ...
    def test_queries_list_table_format(self, setup_config, api_available):
        ...
        result = runner.invoke(
            cli, ["virtualization", "queries", "list", "--format", "table", "--page-size", "5"]
        )
    ...
    def test_queries_get_nonexistent(self, setup_config, api_available):
        ...
        result = runner.invoke(cli, ["virtualization", "queries", "get", fake_id])
    ...
    def test_queries_execute_invalid_dataset(self, setup_config, api_available):
        ...
        fake_id = str(uuid.uuid4())
        result = runner.invoke(cli, ["virtualization", "queries", "execute", fake_id])
