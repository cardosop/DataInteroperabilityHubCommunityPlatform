...
class TestMLTrainingCommandsRealAPI:
    ...
    def test_training_submit_command_structure(
        ...
        if result.exit_code != 0:
            ...
            assert (
                "Failed to submit training job" in result.output
                or "Not authenticated" in result.output
                or "API error" in result.output
                or "ODH" in result.output
    ...
    def test_training_get_command_structure(self, runner, api_available, api_key):
        ...
        result = runner.invoke(cli, ["ml", "training", "get", test_job_id, "--format", "json"])
    ...
    def test_training_cancel_command_structure(self, runner, api_available, api_key):
        ...
        result = runner.invoke(cli, ["ml", "training", "cancel", test_job_id, "--format", "json"])
    ...
    def test_training_logs_command_structure(self, runner, api_available, api_key):
        ...
        result = runner.invoke(cli, ["ml", "training", "logs", test_job_id, "--format", "json"])
    ...
    def test_training_logs_with_lines(self, runner, api_available, api_key):
        ...
        result = runner.invoke(
            cli, ["ml", "training", "logs", test_job_id, "--lines", "100", "--format", "json"]
        )
    ...
    def test_training_get_table_format(self, runner, api_available, api_key):
        ...
        result = runner.invoke(cli, ["ml", "training", "get", test_job_id, "--format", "table"])
