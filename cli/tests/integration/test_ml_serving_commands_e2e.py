...
class TestMLServingE2E:
    ...
    def test_complete_serving_workflow(self, runner, api_available, test_model_id):
        ...
        try:
            ...
            if deploy_result.exit_code == 0:
                ...
                assert (
                    "Failed to deploy model for serving" in deploy_result.output
    ...
    def test_get_serving_command_structure(self, runner, api_available):
        ...
        assert (
            "Failed to get serving deployment" in result.output
    ...
    def test_undeploy_serving_command_structure(self, runner, api_available):
        ...
        assert (
            "Failed to undeploy serving deployment" in result.output
            or "Not authenticated" in result.output
            or "API error" in result.output
            or "Unknown error" in result.output
            or "Server error" in result.output
    ...
    def test_metrics_serving_command_structure(self, runner, api_available):
        ...
        assert (
            "Failed to get serving metrics" in result.output
            or "Not authenticated" in result.output
            or "API error" in result.output
            or "Unknown error" in result.output
            or "Server error" in result.output
...
class TestMLServingABTestE2E:
    ...
    def test_complete_ab_test_workflow(self, runner, api_available, test_model_id):
        ...
        try:
            ...
            if create_result.exit_code == 0:
                ...
                assert (
                    "Failed to create A/B test" in create_result.output
                    or "Not authenticated" in create_result.output
                    or "API error" in create_result.output
                    or "authentication" in output_lower
                    or "not available" in output_lower
                    or "not found" in output_lower
                    or "unknown error" in output_lower
    ...
    def test_get_ab_test_command_structure(self, runner, api_available):
        ...
        assert (
            "Failed to get A/B test" in result.output
            or "Not authenticated" in result.output
            or "API error" in result.output
            or "Unknown error" in result.output
            or "Server error" in result.output
    ...
    def test_create_ab_test_with_invalid_traffic_split(self, runner, api_available, test_model_id):
        ...
        assert (
            "Traffic split percentages must sum to 100" in result.output
            or "Invalid traffic split format" in result.output
        ), f"Unexpected error: {result.output}"
