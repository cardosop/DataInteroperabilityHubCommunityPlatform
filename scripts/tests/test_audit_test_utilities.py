...
""")
    ...
    def test_generate_report(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            assert report_data["summary"]["total_utility_modules"] == len(
                report_data["utility_modules"]
            )
            assert report_data["summary"]["total_helper_functions"] == len(
                report_data["helper_functions"]
            )
            assert report_data["summary"]["total_endpoint_urls"] == len(
                report_data["endpoint_urls"]
            )
