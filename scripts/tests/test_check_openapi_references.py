...
class TestOpenAPISpecParsing:
    ...
    def test_parse_openapi_spec(self):
        ...
        spec_data = {
            ...
            "paths": {
                "/api/v1/users/": {
                    "get": {"operationId": "list_users", "tags": ["users"], "summary": "List users"}
                },
                "/api/v1/users/{id}/": {"get": {"operationId": "get_user", "tags": ["users"]}},
            },
        }
    ...
    def test_extract_tags(self):
        ...
        spec_data = {
            ...
            "info": {"title": "Test API", "version": "1.0.0"},
            "paths": {
                "/api/v1/test/": {"get": {"operationId": "get_test", "tags": ["test", "api"]}}
            },
        }
...
class TestDiscrepancyDetection:
    ...
    def test_detect_missing_in_spec(self):
        ...
        openapi_paths = [
            OpenAPIPath(
                path="/api/v1/users/", methods=["GET"], operation_ids=["list_users"], tags=["users"]
            )
        ]
    ...
    def test_detect_missing_in_urls(self):
        ...
        openapi_paths = [
            ...
            OpenAPIPath(
                path="/api/v1/posts/", methods=["GET"], operation_ids=["list_posts"], tags=["posts"]
            ),  # Missing in URLs
        ]
...
class TestOpenAPISpecChecker:
    ...
    def test_load_from_file(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            spec_data = {
                "openapi": "3.0.0",
                "info": {"title": "Test API", "version": "1.0.0"},
                "paths": {"/api/v1/test/": {"get": {"operationId": "get_test"}}},
            }
    ...
    def test_compare_with_audit_results(self):
        ...
        spec_data = {
            "openapi": "3.0.0",
            "info": {"title": "Test API", "version": "1.0.0"},
            "paths": {"/api/v1/users/": {"get": {"operationId": "list_users"}}},
        }
    ...
    def test_json_output(self):
        ...
        audit_data = {"inventory": {"endpoints": []}}
