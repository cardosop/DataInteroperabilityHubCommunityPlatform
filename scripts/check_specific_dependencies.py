...
def check_python_support(package_name: str) -> tuple[bool | None, str | None, str | None]:
...
def test_installation(package_name: str, version_spec: str) -> tuple[bool, str | None]:
