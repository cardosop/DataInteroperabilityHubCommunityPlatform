...
class InfrastructureVerifier:
    ...
    def verify_cicd_pipelines(self) -> ComponentVerification:
        ...
        component = ComponentVerification(
            component="CI/CD Pipelines", task_id="9.6.3.4.1", tests=[]
        )
        ...
        exit_code, stdout, stderr = self.run_command(
            [
                ...
                "bash",
                "-c",
                "cd /app && PYTHONPATH=/app python scripts/validate_url_patterns.py --strict",
            ]
        )
        duration = (datetime.now() - start).total_seconds()

        if exit_code == 0:
            component.tests.append(
                TestResult(
        ...
        exit_code, stdout, stderr = self.run_command(
            [
                ...
                "bash",
                "-c",
                "cd /app && PYTHONPATH=/app python scripts/validate_api_naming_standards.py --strict",
            ]
        )
        duration = (datetime.now() - start).total_seconds()
    ...
    def verify_monitoring_configurations(self) -> ComponentVerification:
        ...
        component = ComponentVerification(
            component="Monitoring Configurations", task_id="9.6.3.4.2", tests=[]
        )
    ...
    def verify_rate_limiting_configurations(self) -> ComponentVerification:
        ...
        component = ComponentVerification(
            component="Rate Limiting Configurations", task_id="9.6.3.4.3", tests=[]
        )
        ...
        exit_code, stdout, stderr = self.run_command(
            [
                ...
                "bash",
                "-c",
                "cd /app && PYTHONPATH=/app python -m pytest tests/integration/test_rate_limiting_endpoints.py -v --tb=short",
            ]
        )
        duration = (datetime.now() - start).total_seconds()
    ...
    def verify_gateway_configurations(self) -> ComponentVerification:
        ...
        component = ComponentVerification(
            component="API Gateway Configurations", task_id="9.6.3.4.4", tests=[]
        )
        ...
        start = datetime.now()
        exit_code, stdout, stderr = self.run_command(["python3", "scripts/test-gateway-routing.py"])
        duration = (datetime.now() - start).total_seconds()
