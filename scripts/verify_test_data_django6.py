...
def main():
    ...
    print(f"{GREEN}✅ Found {len(factories)} factory files and {len(fixtures)} fixture files{RESET}\n")
    ...
    print(f"{GREEN}✅ {len(compatible_factories)} factory files are compatible with Django 6{RESET}\n")
    ...
    print(f"{GREEN}✅ {len(compatible_fixtures)} fixture files are compatible with Django 6{RESET}\n")
    ...
    report_path = base_dir / 'openspec' / 'changes' / 'fullcontract' / 'DJANGO6_TEST_DATA_VERIFICATION.json'
