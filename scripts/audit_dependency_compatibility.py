...
def check_pypi_compatibility(package_name: str) -> Optional[bool]:
...
def test_dependency_installation(package_name: str, version_spec: str) -> Tuple[bool, Optional[str]]:
