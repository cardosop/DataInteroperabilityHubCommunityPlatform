...
class GapCategorizer:
    ...
    P0_CATEGORIES = {
        'Authentication': ['auth', 'login', 'register', 'logout', 'password-reset', 'api-keys', 'me'],
    ...
    P2_CATEGORIES = {
        'AI/ML': ['ai', 'ml', 'natural-language', 'schema-matching', 'recommendations', 'classification'],
    ...
    def generate_categorization_report(self, output_path: Path):
        ...
        lines.append(f"**Task**: 0.3.2 - Categorize gaps by priority")
        lines.append("")
        lines.append("---")
        lines.append("")
        ...
        if p2_gaps:
            ...
            # AI/ML APIs
            ai_gaps = [g for g in p2_gaps if 'AI' in g.priority_category or 'ML' in g.priority_category]
            if ai_gaps:
        ...
        if p3_gaps:
            ...
            adv_marketplace_gaps = [g for g in p3_gaps if 'Advanced Marketplace' in g.priority_category]
    ...
    def export_json(self, output_path: Path):
        ...
        data = {
            ...
            'categorized_gaps': {
                cat: [asdict(g) for g in gaps]
                for cat, gaps in self.categorized_gaps.items()
            },
...
def main():
    ...
    parser.add_argument('--output', default='docs/api-audit/gap-categorization-by-priority.md',
