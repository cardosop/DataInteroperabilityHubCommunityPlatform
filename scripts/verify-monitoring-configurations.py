        ...
        for old_pattern in OLD_PATTERNS:
            ...
            if old_pattern in line:
                ...
                if stripped.startswith('#') or stripped.startswith('//'):
                    ...
                    if 'deprecated' in line.lower() or 'old' in line.lower() or 'migration' in line.lower():
    ...
    if dashboards_dir.exists():
        ...
        for dashboard_file in sorted(dashboard_files):
            ...
            if dashboard_result['issue_count'] > 0:
                ...
                all_issues.extend([(dashboard_file.name, issue) for issue in dashboard_result['issues']])
            else:
