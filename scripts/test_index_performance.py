...
def test_version_history_indexes(verbose: bool = False) -> List[Tuple[str, bool, str]]:
    ...
    query = """
        ...
        LIMIT 10
    """
    plan = explain_query(query, ('00000000-0000-0000-0000-000000000000', '00000000-0000-0000-0000-000000000000'))
    ...
    query = """
        ...
        LIMIT 10
    """
    plan = explain_query(query, ('00000000-0000-0000-0000-000000000000', '00000000-0000-0000-0000-000000000000', '1.0.0'))
...
def test_observability_indexes(verbose: bool = False) -> List[Tuple[str, bool, str]]:
    ...
    query = """
        ...
        LIMIT 10
    """
    plan = explain_query(query, ('00000000-0000-0000-0000-000000000000', 'SCHEDULED_INGESTION', 'COMPLETED'))
