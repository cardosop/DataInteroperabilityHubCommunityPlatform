...
class APIEffortEstimator:
    ...
    def estimate_effort(
        ...
        if integrations.get('services'):
            ...
            estimate.service_integration_effort = self.SERVICE_INTEGRATION_EFFORT.get(svc_complexity, 0.0)
        
        # Workflow integration effort
        if has_workflow:
            wf_complexity = integrations.get('workflow', 'simple')
            estimate.workflow_integration_effort = self.WORKFLOW_INTEGRATION_EFFORT.get(wf_complexity, 0.0)
...
def estimate_api_efforts() -> Dict[str, Any]:
    ...
    api_characteristics = {
        ...
        'POST /api/v1/auth/register/': {
            ...
            'integration_count': 0,
            'dependencies': {'database': 'simple', 'external_service': 'none', 'infrastructure': 'none'},
        ...
        'GET /api/v1/auth/me/': {
            ...
            'integration_count': 0,
            'dependencies': {'database': 'none', 'external_service': 'none', 'infrastructure': 'none'},
            'integrations': {'services': 'none', 'workflow': 'none'},
        },
        ...
        'POST /api/v1/scheduled-ingestions/{id}/credentials/test/': {
            ...
            'integration_count': 1,
            'dependencies': {'database': 'none', 'external_service': 'medium', 'infrastructure': 'none'},
        ...
        'POST /api/v1/ai/natural-language-search/': {
            ...
            'integration_count': 1,
            'dependencies': {'database': 'none', 'external_service': 'complex', 'infrastructure': 'simple'},
            'integrations': {'services': 'single', 'workflow': 'none'},
        },
        ...
        'POST /api/v1/social/communities/': {
            ...
            'has_external_service': False,
            'integration_count': 0,
            'dependencies': {'database': 'medium', 'external_service': 'none', 'infrastructure': 'none'},
            'integrations': {'services': 'none', 'workflow': 'none'},
        },
