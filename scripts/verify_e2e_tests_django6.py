            ...
            if isinstance(node, ast.ClassDef):
                ...
                for base in node.bases:
                    if isinstance(base, ast.Name):
                        base_name = base.id
                        if base_name in ['TestCase', 'TransactionTestCase', 'LiveServerTestCase', 'APITestCase']:
...
def main():
    ...
    report_path = base_dir / 'openspec' / 'changes' / 'fullcontract' / 'DJANGO6_E2E_TESTS_VERIFICATION.json'
