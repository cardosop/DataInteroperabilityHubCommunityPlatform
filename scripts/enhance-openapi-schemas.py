...
class SchemaEnhancer:
    ...
    def _enhance_property(self, prop_schema: Dict[str, Any], prop_name: str, 
                         parent_schema_name: str) -> Dict[str, Any]:
        ...
        if prop_type == 'string':
            ...
            if 'items' in enhanced and isinstance(enhanced['items'], dict):
                enhanced['items'] = self._enhance_property(enhanced['items'], 'item', parent_schema_name)
    ...
    def enhance_request_body(self, request_body: Dict[str, Any], 
    ...
    def enhance_responses(self, responses: Dict[str, Any], 
                         path: str, method: str) -> Dict[str, Any]:
    ...
    def _generate_request_example(self, path: str, method: str) -> Optional[Dict[str, Any]]:
        """Generate request example based on path and method."""
        # Examples are already in the specs, so return None to preserve them
        return None
    
    def _generate_response_example(self, path: str, method: str, 
                                  status_code: str) -> Optional[Dict[str, Any]]:
