# Marketplace & Platform Admin Reference

Quick links to the API, CLI, and SDK references most relevant to the
Marketplace & Platform Admin persona.
...
| Resource | Link |
|----------|------|
| Users REST API | [API Reference: Users](../../api-reference/users.md) |
| Django Admin: Users | `/admin/users/` |
...
- [Marketplace & Platform Admin Overview](index.md)
