...
#### `pipeline.started`
Published when a transformation pipeline execution starts.
...
#### `pipeline.completed`
Published when a transformation pipeline execution completes successfully.
...
#### `pipeline.failed`
Published when a transformation pipeline execution fails.
...
Published when a transformation pipeline is created.
...
#### `transformation.pipeline.updated`
Published when a transformation pipeline is updated.
...
#### `transformation.pipeline.deleted`
Published when a transformation pipeline is deleted.
...
Published during transformation pipeline execution to report progress.
...
Published when a transformation pipeline execution step completes.
...
Published during transformation preview generation to report progress.
...
Published when a transformation preview is generated.
...
Published when a wrangling operation is applied.
